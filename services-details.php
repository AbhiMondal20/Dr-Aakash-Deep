...
$id = $_GET['id'];
$title = $_GET['title'];
$sql = "SELECT * FROM services WHERE id = '$id' AND title = '$title'";
    ...
    <div class="main-container w-container">
        <div class="doctors-container">
            <div class="doctors-plans-heading">
                ...
                <div class="h3 bold"><?php echo $title; ?></div>
            </div>
            <div class="doctors-blocks-wrapper2">
                <div class="doctor-block2">
                    <img src="<?php echo 'backend/admin/' . $images; ?>" loading="lazy"
                        ...
                        <?php echo 'backend/admin/' . $images; ?> 704w" alt="doctor&#x27;s image" class="doctor-image" />
