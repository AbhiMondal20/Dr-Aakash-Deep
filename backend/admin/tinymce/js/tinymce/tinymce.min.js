...
!(function () {
  ...
  const Fo = (e) => (t) => !!t && t.nodeType === e,
    ...
    Lr = Yo,
    Mr = (e) => (
      Lr(e) && (e = e.parentNode), Pr(e) && e.hasAttribute("data-mce-caret")
    ),
    Ir = (e) => Lr(e) && Br(e.data),
    Fr = (e) => Mr(e) || Ir(e),
  ...
  const Rf = (e) => "textarea" === jt(e),
    ...
    eg = (e) =>
      (e.bookmark ? e.bookmark : I.none())
        .bind((t) => {
          return (
            (n = bn(e.getBody())), (o = t), I.from(o).filter(Xf(n)).map(Gf)
          );
          var n, o;
        })
        .bind(Jf),
        ...
        e
          ? ((e, t) =>
              zp(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    lu(e, Ti.after(t)).orThunk(() => du(e, Ti.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              Up(t)
                .orThunk(() => zp(t))
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                ob(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (db(e, t.dom, n) ? I.some(n) : I.none()))(n, t)
                    ),
                  n
                )
              )
          ...
          () =>
            ((e, t, n) => {
              ...
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (
                    e._selectionOverrides.hideFakeCaret(), qp(e, t, bn(n)), !0
                  ))(e, t),
                  ((e, t) => (n) => {
      ...
      if (t && FE(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => qx(Xx(e, Ti.after(t)), n.left))
            )
  ...
  class NO {
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = EO.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
