                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="file" class="form-control" required placeholder="Images" name="arc_file" id="arc_file" accept=".png, .webp">
                                        </div>
                                        <label id="imageSizeLabel" for="floatingInputGroup2" style="color: red;">500 x 500 (Images Dimensions) Archive Image For Home Page</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
    ...
    if (
        ...
        if (move_uploaded_file($img_temp, $img_upload)) {
            ...
            if (move_uploaded_file($arc_img_temp, $arc_img_upload)) {
                ...
                $sql = "INSERT INTO `services`(`title`, `description`, `arc_images`, `images`, `added_by`) VALUES ('$title','$desc','$arc_img_upload','$img_upload','$added_by')";
