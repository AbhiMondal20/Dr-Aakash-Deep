...
<?php
    $services_id = $_GET['id'];
    $title = $_GET['title'];
    $sql = "SELECT * FROM services WHERE id = '$services_id' AND title = '$title'";
...
// Check if a new image is being uploaded
    ...
    $sql = "UPDATE `services` SET `title`='$title',`description`='$desc',`arc_images`='$arc_img_upload',`images`='$img_upload',`modified_by`='$modified_by',`modified_date`='$modified_date' WHERE id = '$services_id'";
    $res = mysqli_query($conn, $sql);
     if ($res) {
        echo '<script>swal("Update Successful", "Services Details have been Successfully Updated", "success")
            setTimeout(function(){
