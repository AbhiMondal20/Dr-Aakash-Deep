    ...
    if ("undefined" == typeof DayPilot.$) {
      "undefined" == typeof DayPilot.Global && (DayPilot.Global = {}),
        ...
        (DayPilot.mo2 = function (e, t) {
          if (((t = t || window.event), "undefined" != typeof t.offsetX)) {
            ...
            for (var a = t.srcElement; a && a !== e; )
              "SPAN" !== a.tagName &&
                ((i.x += a.offsetLeft),
                a.offsetTop > 0 && (i.y += a.offsetTop - a.scrollTop)),
                (a = a.offsetParent);
            return a ? i : null;
          }
        ...
        (DayPilot.mo3 = function (e, t) {
          ...
          else if (((i = DayPilot.mo2(e, t)), !i)) return null;
          return (
            (i.shift = t.shiftKey),
            (i.meta = t.metaKey),
            (i.ctrl = t.ctrlKey),
        ...
        (DayPilot.abs = function (e, t) {
          ...
          if (e.getBoundingClientRect) {
            ...
            if (t) {
              var a = DayPilot.absOffsetBased(e, !1),
        ...
        (DayPilot.sheet = function () {
          ...
          return (
            ...
            (i.add = function (i, a, n) {
              return t
                ? void this.rules.push(i + "{" + a + "}")
                : void (e.sheet.insertRule
                    ? ("undefined" == typeof n && (n = e.sheet.cssRules.length),
                      e.sheet.insertRule(i + "{" + a + "}", n))
                    : e.sheet.addRule && e.sheet.addRule(i, a, n));
            }),
            i
          );
        }),
          ...
          if (!DayPilot.Global.defaultCss) {
            ...
            e.add(
              ...
              e.add(
                ...
                "position: absolute;top: 2px;bottom: 2px;left: 2px;right: 2px;overflow:hidden;padding: 2px;margin-right: 1px; font-size: 13px;"
              ),
              e.add(
              ...
              e.add(
                ...
                "position: absolute;overflow: hidden;top: 0px;bottom: 0px;left: 0px;right: 0px;padding: 2px 2px 2px 8px; font-size: 13px;"
              ),
              e.add(
              ...
              e.add(
                ...
                "position: absolute;left: 0px;right: 0px;top: 0px;bottom: 0px;border-right: 1px solid #eee;padding: 2px;"
              ),
              e.add(
                ".scheduler_default_timeheadergroup, .scheduler_default_timeheadercol",
                "text-align: center;"
              ...
              e.add(
                ...
                "background-color: #666666;opacity: 0.5;filter: alpha(opacity=50);height: 100%;xborder-radius: 5px;"
              ),
        ...
        (DayPilot.pu = function (e) {
          ...
          if (n)
            for (i = n.length, t = 0; t < i; t += 1)
              n[t] &&
                ((a = n[t].name), "function" == typeof e[a] && (e[a] = null));
          if ((n = e.childNodes))
            for (i = n.length, t = 0; t < i; t += 1) {
            ...
            (n.onreadystatechange = function () {
              if (4 === n.readyState)
                return 200 !== n.status && 304 !== n.status
                  ? void (a
                      ? a(n)
                      : window.console && console.log("HTTP error " + n.status))
                  : void t(n);
            }),
            4 !== n.readyState &&
              ("object" == typeof i && (i = JSON.stringify(i)), n.send(i)));
        }),
        (DayPilot.ajax = function (e) {
          ...
          var i = "object" == typeof e.data,
            a = e.data,
            n = e.method || (e.data ? "POST" : "GET"),
            o = e.success || function () {},
            r = e.error || function () {},
            s = e.url,
            l = e.contentType || (i ? "application/json" : "text/plain"),
            d = e.headers || {};
          t.open(n, s, !0),
        ...
        (DayPilot.Areas = {}),
        (DayPilot.Areas.attach = function (e, t, i) {
          var i = i || {},
            n = i.areas,
            o =
              i.allowed ||
          ...
          (n = a(t, n)),
            n &&
              DayPilot.isArray(n) &&
              0 !== n.length &&
              (DayPilot.re(e, "mousemove", function (a) {
                e.active ||
                  e.areasDisabled ||
                  !o() ||
                  DayPilot.Areas.showAreas(e, t, a, n, {
                    offsetX: r,
                    eventDiv: i.eventDiv,
                  });
              }),
              ...
              n.forEach(function (a) {
                if (DayPilot.Areas.isVisible(a)) {
                  var n = DayPilot.Areas.createArea(e, t, a, {
                    offsetX: r,
                    eventDiv: i.eventDiv,
                  });
                  e.appendChild(n);
      ...
      (DayPilot.Areas.showAreas = function (e, t, i, a, n) {
        if (
          ...
          if (
            ...
            DayPilot.isArray(a) ||
              ((a = t.areas),
              a ||
                (t.cache ? (a = t.cache.areas) : t.data && (a = t.data.areas))),
            a && 0 !== a.length && !(e.areas && e.areas.length > 0))
          ) {
            e.areas = [];
        ...
        (DayPilot.Areas.createArea = function (e, t, i, a) {
          ...
          function r(e, t, i, a) {
            ...
            if (
              (n instanceof DayPilot.Menu ||
                (t.isEvent && t.client.contextMenu()
                  ? (n = t.client.contextMenu())
                  : t.isEvent &&
                    t.calendar.contextMenu &&
                    (n = t.calendar.contextMenu)),
              n && n.show)
            ) {
          ...
          if (
            ("undefined" != typeof i.style && d.setAttribute("style", i.style),
            (d.style.position = "absolute"),
            (d.style.width = s(c)),
            (d.style.height = s(u)),
            (d.style.right = s(i.right)),
            (d.style.top = s(i.top)),
            (d.style.left = s(i.left)),
            (d.style.bottom = s(i.bottom)),
            "undefined" != typeof i.html || "undefined" != typeof i.text)
          )
            ...
            var p = "http://www.w3.org/2000/svg",
              v = document.createElementNS(p, "svg");
            v.setAttribute("width", "100%"), v.setAttribute("height", "100%");
            var y = document.createElementNS(p, "use");
            y.setAttribute("href", i.symbol),
              v.appendChild(y),
              d.appendChild(v);
          }
          if (
            (h && (d.className = h),
            i.toolTip && d.setAttribute("title", i.toolTip),
            i.backColor && (d.style.background = i.backColor),
            i.background && (d.style.background = i.background),
            i.fontColor && (d.style.color = i.fontColor),
            i.padding &&
              ((d.style.padding = i.padding + "px"),
          ...
          if (
            ...
            var g = (function (e, t, i) {
              return function (a) {
                ...
                (t.calendar.coords = n.relativeCoords(a)),
                  (n.preventEventTap = !0),
          ...
          if (
            ("Bubble" === i.action && t.isEvent
              ...
              : "Bubble" === i.action &&
                "undefined" != typeof DayPilot.Bubble &&
                i.bubble instanceof DayPilot.Bubble &&
                ((d.onmousemove = (function (e, t, i) {
                  return function (e) {
          ...
          return (
            (d.onmousedown = (function (e, t, i) {
              return function (a) {
                if (
                  ("function" == typeof i.onmousedown && i.onmousedown(a),
                ...
                "undefined" != typeof DayPilot.Bubble &&
                  ...
                  "Move" === i.action &&
                    ...
                    t.calendar.internal.startMoving(e, a);
                "Move" !== i.action &&
                  "ResizeEnd" !== i.action &&
                  "ResizeStart" !== i.action &&
                  i.action &&
          ...
          function t(e, t, a) {
            ...
            (o &&
              ...
              ("function" == typeof i.onChange &&
                (i.onChange(n), n.preventDefault.value)) ||
                ("function" == typeof i.onTimeRangeSelect &&
                  (i.onTimeRangeSelect(n), n.preventDefault.value)) ||
                (i.active.sendNavigate(i.day),
                "function" == typeof i.onChanged && i.onChanged(n),
                "function" == typeof i.onTimeRangeSelected &&
                  i.onTimeRangeSelected(n)));
          }
          var i = this;
          (this.views = []),
            (this.triggers = []),
              ...
              return (
                ...
                (o.sendNavigate = function (e) {
                  (function () {
                    return (
                      !!n.backendUrl ||
                      !("function" != typeof WebForm_DoCallback || !n.uniqueID)
                    );
                  })()
                    ? n.commandCallBack &&
                      n.commandCallBack("navigate", { day: e })
                    : ((n.startDate = e), n.update());
                }),
                (o.show = function () {
                  i.f(),
                    n.show
            ...
            (this.show = function (e) {
              var a, n;
              if (e.isTrigger) (n = e), (a = n.view);
              else if (((a = e.isView ? e : this.i(e)), this.active === a))
                return;
              if (i.onSelect) {
                var o = {};
                (o.source = n ? n.element : null),
                  (o.target = a.control),
                  i.onSelect(o);
              }
              (this.active = a), a.show();
              var r = a.selectMode();
              i.navigator.updateMode(r),
                t(
                  i.navigator.control.selectionStart,
                  i.navigator.control.selectionEnd.addDays(1),
                  i.navigator.control.selectionDay
                );
            }),
            (this.i = function (e) {
            ...
            DayPilot.Date.Cache.DurationCtor["" + e]
              ...
              : ((DayPilot.Date.Cache.DurationCtor["" + e] = this),
                (this.toString = function (e) {
                  ...
                  return (
                    (a = a.replace("mm", i)),
                    (a = a.replace("m", t.minutes())),
                    (a = a.replace("H", t.hours())),
                    (a = a.replace("h", t.hours())),
                    (a = a.replace("d", t.days())),
                    (a = a.replace("s", t.seconds()))
                  );
                }),
      ...
      (DayPilot.Date = function (t, i) {
        ...
        var a;
        DayPilot.Util.isNullOrUndefined(t) &&
          ((a = DayPilot.DateUtil.fromLocal().getTime()), (t = a));
        var n = DayPilot.Date.Cache.Ctor;
        if (n[t]) return (DayPilot.Stats.cacheHitsCtor += 1), n[t];
        var o = !1;
        if ("string" == typeof t)
          (a = DayPilot.DateUtil.fromStringSortable(t, i).getTime()), (o = !0);
        ...
        return n[r]
          ...
          : ((n[r] = this),
            (n[a] = this),
            o && r !== t && DayPilot.DateUtil.hasTzSpec(t) && (n[t] = this),
            Object.defineProperty && !DayPilot.browser.ielt9
              ...
              : ((this.ticks = a), (this.value = r)),
            DayPilot.Date.Config.legacyShowD && (this.d = new Date(a)),
        ...
        (DayPilot.Date.prototype.addMonths = function (e) {
          ...
          return (
            n.setUTCDate(Math.min(o, t.getUTCDate())), new DayPilot.Date(n)
          );
        }),
        ...
        (DayPilot.Date.prototype.firstDayOfWeek = function (e) {
          ...
          for (var a = t.dayOfWeek(); a !== e; )
            (t = t.addDays(-1)), (a = t.dayOfWeek());
      ...
      (DayPilot.Date.today = function () {
        ...
        (DayPilot.DateUtil.fromStringSortable = function (e, t) {
          ...
          if (!a && !n && !o)
            throw (
              "Invalid string format (use '2010-01-01' or '2010-01-01T00:00:00'): " +
              e
            );
          ...
          var r = e.substring(0, 4),
            ...
            l = e.substring(8, 10),
            d = new Date(0);
          if ((d.setUTCFullYear(r, s - 1, l), a))
            return (DayPilot.Date.Cache.Parsing[e] = d), d;
          var c = e.substring(11, 13),
            u = e.substring(14, 16),
            h = e.substring(17, 19);
          if ((d.setUTCHours(c), d.setUTCMinutes(u), d.setUTCSeconds(h), n))
            return (DayPilot.Date.Cache.Parsing[e] = d), d;
          var f = e[19],
            m = 0;
          if ("." === f) {
            ...
            d.setUTCMilliseconds(p),
              (m = DayPilot.DateUtil.getTzOffsetMinutes(e.substring(23)));
        ...
        (DayPilot.DateUtil.daysDiff = function (e, t) {
          if (
            ...
            return null;
          for (var i = 0, a = e.getDatePart(), n = t.getDatePart(); a < n; )
            (a = a.addDays(1)), i++;
          return i;
        }),
      ...
      var n = function (e, i) {
        ...
        (this.init = function () {
              ...
              : {
                  findValue: function (o) {
                    for (var r = n(e), s = null, l = 0; l < a.length; l++) {
                      var d = (a[l].length, t === a[l].seq),
                        c = a[l].expr;
                      d && ((c = "(" + c + ")"), (s = a[l].transform)),
                        (r = r.replace(a[l].seq, c));
                    }
                    r = "^" + r + "$";
                    try {
                      var u = new RegExp(r),
          ...
          (this.parse = function (e) {
            ...
            var a = this.day.findValue(e),
              n = DayPilot.Date.fromYearMonthDay(t, i).daysInMonth();
      ...
      (DayPilot.ColorUtil = {}),
        ...
        (DayPilot.ColorUtil.darker = function (e, t) {
          ...
          var a = 17,
            n = t * a,
            o = DayPilot.ColorUtil.adjustLuminance(i, -n);
        ...
        (DayPilot.ColorUtil.pl = function (e) {
          var t = DayPilot.ColorUtil.hexToRgb(e),
            ...
            a = t.g / 255,
            n = t.b / 255;
          return Math.sqrt(0.299 * i * i + 0.587 * a * a + 0.114 * n * n);
        }),
        (DayPilot.ColorUtil.contrasting = function (e, t, i) {
          var a = DayPilot.ColorUtil.pl(e);
          return (t = t || "#ffffff"), (i = i || "#000000"), a > 0.5 ? i : t;
        }),
        (DayPilot.Event = function (e, t, i) {
          ...
          (this.isEvent = !0),
            ...
            (this.start = function (e) {
              return "undefined" == typeof e
                ? new DayPilot.Date(a.data.start)
                : void (this.temp().start = new DayPilot.Date(e));
            }),
            (this.end = function (e) {
              return "undefined" == typeof e
                ? new DayPilot.Date(a.data.end)
            ...
            (this.tag = function (e) {
              ...
              for (
                var i = a.calendar.tagFields, n = -1, o = 0;
                o < i.length;
                o++
              )
                e === i[o] && (n = o);
            ...
            (this.client.innerHTML = function (e) {
              if ("undefined" == typeof e) {
                var t = a.cache || a.data,
                  i =
                    a.calendar &&
                    a.calendar.internal &&
                    a.calendar.internal.xssTextHtml;
                return i
                  ? i(t.text, t.html)
            ...
            (this.client.header = function (e) {
              return "undefined" == typeof e
                ? a.data.header
                : void (a.data.header = e);
            }),
            (this.client.cssClass = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.cssClass
                  ? a.cache.cssClass
                  : a.data.cssClass
                : void (a.data.cssClass = e);
            }),
            (this.client.toolTip = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.toolTip
                  ? a.cache.toolTip
                  : "undefined" != typeof a.data.toolTip
                  ? a.data.toolTip
                  : a.data.text
                : void (a.data.toolTip = e);
            }),
            (this.client.barVisible = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.barHidden
                  ? !a.cache.barHidden
                  : a.calendar.durationBarVisible && !a.data.barHidden
                : void (a.data.barHidden = !e);
            }),
            (this.client.backColor = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.backColor
                  ? a.cache.backColor
                  : "undefined" != typeof a.data.backColor
                  ? a.data.backColor
                  : a.calendar.eventBackColor
                : void (a.data.backColor = e);
            }),
            (this.client.borderColor = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.borderColor
                  ? a.cache.borderColor
                  : "undefined" != typeof a.data.borderColor
                  ? a.data.borderColor
                  : a.calendar.eventBorderColor
                : void (a.data.borderColor = e);
            }),
            ...
            (this.client.moveEnabled = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.moveDisabled
                  ? !a.cache.moveDisabled
                  : "Disabled" !== a.calendar.eventMoveHandling &&
                    !a.data.moveDisabled
                : void (a.data.moveDisabled = !e);
            }),
            (this.client.resizeEnabled = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.resizeDisabled
                  ? !a.cache.resizeDisabled
                  : "Disabled" !== a.calendar.eventResizeHandling &&
                    !a.data.resizeDisabled
                : void (a.data.resizeDisabled = !e);
            }),
            (this.client.clickEnabled = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.clickDisabled
                  ? !a.cache.clickDisabled
                  : "Disabled" !== a.calendar.eventClickHandling &&
                    !a.data.clickDisabled
                : void (a.data.clickDisabled = !e);
            }),
            (this.client.rightClickEnabled = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.rightClickDisabled
                  ? !a.cache.rightClickDisabled
                  : "Disabled" !== a.calendar.eventRightClickHandling &&
                    !a.data.rightClickDisabled
                : void (a.data.rightClickDisabled = !e);
            }),
            (this.client.deleteEnabled = function (e) {
              return "undefined" == typeof e
                ? a.cache && "undefined" != typeof a.cache.deleteDisabled
                  ? !a.cache.deleteDisabled
                  : "Disabled" !== a.calendar.eventDeleteHandling &&
                    !a.data.deleteDisabled
                : void (a.data.deleteDisabled = !e);
            }),
            (this.toJSON = function (e) {
              var t = {};
              if (
                ...
                (t.end = this.end()),
                (t.tag = {}),
                a.calendar && a.calendar.tagFields)
              )
                for (var i = a.calendar.tagFields, n = 0; n < i.length; n++)
                  t.tag[i[n]] = this.tag(i[n]);
              return t;
            });
        });
    }
  ...
  (function () {
    ...
    function i(e, r) {
      var s,
        ...
        f = r[e];
      switch (
        (f && "object" == typeof f && "function" == typeof f.toJSON2
          ? (f = f.toJSON2(e))
          : f &&
            "object" == typeof f &&
        ...
        case "object":
          ...
          if (
            ((a += n),
            (u = []),
            "number" == typeof f.length && !f.propertyIsEnumerable("length"))
          ) {
          ...
          if (o && "object" == typeof o)
            for (c = o.length, s = 0; s < c; s += 1)
              (l = o[s]),
                "string" == typeof l &&
                  ((d = i(l, f)), d && u.push(t(l) + (a ? ": " : ":") + d));
          else
            for (l in f)
              Object.hasOwnProperty.call(f, l) &&
                ((d = i(l, f)), d && u.push(t(l) + (a ? ": " : ":") + d));
          return (
            (d =
              0 === u.length
    ...
    "function" != typeof DayPilot.JSON.stringify &&
      (DayPilot.JSON.stringify = function (e, t, r) {
        var s;
        if (((a = ""), (n = ""), "number" == typeof r))
          for (s = 0; s < r; s += 1) n += " ";
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
      ...
      (t.selectedCells = []),
        ...
        (t.getCellsAbove = function (e) {
          for (
            var i = [], a = t.getColumn(e), n = e.parentNode, o = null;
            n && o !== t.firstSelected;

          )
            for (
              o = n.getElementsByTagName("td")[a],
                i.push(o),
                n = n.previousSibling;
              n && "TR" !== n.tagName;
        ...
        (t.getCellsBelow = function (e) {
          for (
            ...
            for (
              o = n.getElementsByTagName("td")[a], i.push(o), n = n.nextSibling;
              n && "TR" !== n.tagName;
        ...
        (t.gMouseUp = function (i) {
          if (t.resizing) {
            ...
            (t.moving = null),
              ...
              (t.movingShadow = null),
              (a.calendar.nav.top.style.cursor = "auto"),
              a.calendar.p(a, s, o, i);
          } else if (t.selecting && null !== t.topSelectedCell) {
            var l = t.selecting.calendar;
            t.selecting = !1;
            var d = l.getSelection();
            l.q(d.start, d.end, d.resource),
              "Hold" !== l.timeRangeSelectedHandling &&
                "HoldForever" !== l.timeRangeSelectedHandling &&
                e();
          } else t.selecting = !1;
        }),
        ...
        (t.moveShadow = function (e) {
          ...
          (a.style.display = "none"),
            ...
            (i.style.left = "0px"),
            (a.style.display = ""),
            (i.style.width = t.movingShadow.parentNode.offsetWidth + 1 + "px");
        }),
        (t.Calendar = function (e, i) {
          var a = !1;
          if (
            (this instanceof t.Calendar && !this.s && ((a = !0), (this.s = !0)),
            !a)
          )
          ...
          (this.uniqueID = null),
            ...
            (this.t = function () {
              DayPilot.de(n.elements.selection),
                (n.elements.selection = []),
                (n.nav.activeSelection = null);
            }),
            (this.u =
              navigator &&
              navigator.userAgent &&
            ...
            (this.B = function (e, t, i) {
              ...
              var o = "JSON" + DayPilot.JSON.stringify(a);
              this.backendUrl
                ? DayPilot.request(this.backendUrl, this.C, o, this.ajaxError)
            ...
            (this.A = function () {
              ...
              return (
                ...
                (e.businessBeginsHour = n.businessBeginsHour),
                (e.businessEndsHour = n.businessEndsHour),
                (e.hashes = n.hashes),
            ...
            (this.I = function (e, t) {
              ...
              a.setAttribute("unselectable", "on"),
                ...
                (a.style.zIndex = 101),
                (a.className = n.o("_shadow"));
              var o = document.createElement("div");
              return (
                (o.className = n.o("_shadow_inner")),
                a.appendChild(o),
                i.firstChild.appendChild(a),
                a
              );
            }),
            (this.J = {}),
            (this.J.locale = function () {
              var e = DayPilot.Locale.find(n.locale);
              return e ? e : DayPilot.Locale.US;
            }),
            (this.J.timeFormat = function () {
              return "Auto" !== n.timeFormat
                ? n.timeFormat
          ...
          (this.D = function (e, t) {
            if (e && 0 === e.indexOf("$$$")) {
              ...
              return void console.log(
                "Error received from the server side: " + e
              );
            }
            var e = JSON.parse(e);
            if (e.CallBackRedirect)
              return void (document.location.href = e.CallBackRedirect);
            if ("None" === e.UpdateType) return n.loadingStop(), void n.L();
            if (
              (n.E(),
              "Full" === e.UpdateType &&
                ((n.columns = e.Columns),
                (n.days = e.Days),
                (n.startDate = new DayPilot.Date(e.StartDate)),
                (n.heightSpec = e.HeightSpec ? e.HeightSpec : n.heightSpec),
                (n.businessBeginsHour = e.BusinessBeginsHour
                  ? e.BusinessBeginsHour
                  : n.businessBeginsHour),
                (n.businessEndsHour = e.BusinessEndsHour
                  ? e.BusinessEndsHour
                  : n.businessEndsHour),
                (n.headerDateFormat = e.HeaderDateFormat
                  ? e.HeaderDateFormat
                  : n.headerDateFormat),
                (n.viewType = e.ViewType),
                (n.backColor = e.BackColor ? e.BackColor : n.backColor),
                (n.eventHeaderVisible = e.EventHeaderVisible
                  ? e.EventHeaderVisible
                  : n.eventHeaderVisible),
                (n.timeFormat = e.TimeFormat ? e.TimeFormat : n.timeFormat),
                (n.locale = e.Locale ? e.Locale : n.locale),
                n.M()),
              e.Hashes)
            )
              for (var i in e.Hashes) n.hashes[i] = e.Hashes[i];
            (n.events.list = e.Events),
              n.N(),
              n.O(),
              "Full" === e.UpdateType && (n.P(), n.Q(), n.R(), n.S()),
              n.L(),
              n.T(),
              n.clearSelection(),
              n.afterRender(e.CallBackData, !0),
              n.loadingStop();
          }),
            (this.U = function () {
              return this.V() / 36e5;
            ...
            (this.V = function () {
              ...
              return (
                (e =
                  "BusinessHoursNoScroll" === this.heightSpec ? this.W() : 24),
                60 * e * 60 * 1e3
              );
            }),
            (this.Y = function () {
              return "BusinessHoursNoScroll" === this.heightSpec
            ...
            (this.eventClickCallBack = function (e, t) {
              this.B("EventClick", t, e);
            }),
            (this.eventClickPostBack = function (e, t) {
              this.z("EventClick", t, e);
            }),
            (this._ = function (e) {
              var t = this,
                i = t.event;
            ...
            (this.ba = function (e) {
              ...
              if (
                ...
                "function" == typeof n.onEventRightClick &&
                  (n.onEventRightClick(i), i.preventDefault.value))
              )
                return !1;
            ...
            (this.eventResizePostBack = function (e, t, i, a) {
              ...
              (n.e = e),
                (n.newStart = t),
                (n.newEnd = i),
                this.z("EventResize", a, n);
            }),
            (this.n = function (e, t, i, a) {
              var o = 1,
                r = new Date(),
                s = new Date(),
                l = e.start(),
              ...
              if ("top" === a) {
                ...
                var c = d.getDatePart(),
                  u = Math.floor((i + t - o) / n.cellHeight),
                  h = 30 * u,
                  f = 60 * h * 1e3,
                  m = 60 * n.Y() * 60 * 1e3;
                (r = l), (s = c.addTime(f + m));
            ...
            (this.eventMoveCallBack = function (e, t, i, a, n) {
              ...
              (o.e = e),
                (o.newStart = t),
                (o.newEnd = i),
                this.B("EventMove", n, o);
            }),
            (this.p = function (e, t, i, a) {
              var o = 1,
                r = Math.floor((i - o) / n.cellHeight),
                s = 30 * r * 60 * 1e3,
                l = e.start(),
                d = e.end(),
                c = new Date();
              ...
              var u =
                  ...
                  (c.getTime() +
                    ...
                    30 * Math.floor(l.getUTCMinutes() / 30) * 60 * 1e3),
            ...
            (this.timeRangeSelectedPostBack = function (e, t, i, a) {
              var n = {};
              (n.start = e), (n.end = t), this.z("TimeRangeSelected", a, n);
            }),
            (this.timeRangeSelectedCallBack = function (e, t, i, a) {
              var n = {};
              (n.start = e), (n.end = t), this.B("TimeRangeSelected", a, n);
            }),
            (this.q = function (e, t, i) {
              if (
                ((e = new DayPilot.Date(e)),
                (t = new DayPilot.Date(t)),
                this.Z())
              ...
              if (!t.selecting && "Disabled" !== n.timeRangeSelectedHandling) {
                ...
                if (1 === i || 0 === i)
                  return (
                    ...
                    (t.selecting = {}),
                    (t.selecting.calendar = n),
                    t.selectedCells &&
                      (n.clearSelection(), (t.selectedCells = [])),
            ...
            (this.fa = function () {
              ...
              !(function () {
                ...
                if (o) {
                  var r = o.start,
                    s = n.getPixels(e.start, r).boxTop,
                    l = n.getPixels(i.end, r).boxBottom,
                    d = l - s,
                    c = (function () {
                      ...
                      return (
                        ...
                        (t.className = n.o("_shadow_inner")),
                        e.appendChild(t),
                        n.nav.events.rows[0].cells[a].selection.appendChild(e),
                        n.elements.selection.push(e),
                        (n.nav.activeSelection = e),
                        e
                      );
                    })();
                  (c.className = n.o("_shadow")),
              ...
              if ("undefined" != typeof t && t.selecting) {
                ...
                t.getColumn(this) === t.column &&
                  ...
                  i.y < t.firstMousePos.y
                    ? ((t.selectedCells = t.getCellsBelow(this)),
                      (t.topSelectedCell = t.selectedCells[0]),
                      (t.bottomSelectedCell = t.firstSelected))
                    : ((t.selectedCells = t.getCellsAbove(this)),
                      (t.topSelectedCell = t.firstSelected),
                      (t.bottomSelectedCell = t.selectedCells[0])),
                  n.fa());
              }
            }),
            (this.getSelection = function () {
              var e = t.topSelectedCell.start,
                ...
                a = t.topSelectedCell.resource;
              return new DayPilot.Selection(e, i, a, n);
            }),
            (this.ha = function (e) {
              if (e < 0) return null;
              for (
                var t = 0, i = n.nav.events.rows[0].cells, a = 0;
                a < i.length;
                a++
              ) {
            ...
            (this.ia = {}),
            (this.ia.getCellCoords = function () {
              var e = {};
              if (((e.x = 0), (e.y = 0), !n.coords)) return null;
              e.x = n.ha(n.coords.x);
              var t = 0,
                i = Math.floor((n.coords.y - t) / n.cellHeight);
                ...
                o = function (e) {
                  ...
                  if (DayPilot.isArray(i)) {
                    ...
                    if (
                      ...
                      return;
                    (n.columns.list = i), n.ja && n.update();
                  }
                };
              n.columnsLoadMethod &&
              "POST" === n.columnsLoadMethod.toUpperCase()
                ? DayPilot.ajax({
                    method: "POST",
                    url: e,
                    success: o,
            ...
            (this.M = function () {
              var e;
              (e = "Resources" !== n.viewType ? this.ka() : n.columns.list),
                (this.da = []);
            ...
            (this.la = function (e) {
              ...
              return (
                ...
                (t.data = e),
                e.start
                  ? (t.start = new DayPilot.Date(e.start))
                  : (t.start = new DayPilot.Date(n.startDate)),
            ...
            (this.ka = function () {
              ...
              "BusinessHoursNoScroll" === this.heightSpec &&
                (t = t.addHours(this.businessBeginsHour));
              for (var a = 0; a < i; a++) {
                var r = n.headerDateFormat
                    ? n.headerDateFormat
                    : o.locale().datePattern,
                  s = {};
                (s.start = t.addDays(a)),
                  (s.name = s.start.toString(r, o.locale())),
                  e.push(s);
              }
              return e;
            }),
            (this.visibleStart = function () {
              if ("Resources" === n.viewType) {
                if (0 === n.da.length) return DayPilot.Date.today();
                var e = n.da.map(function (e) {
            ...
            (this.visibleEnd = function () {
              if ("Resources" === n.viewType) {
                if (0 === n.da.length) return DayPilot.Date.today().addDays(1);
                var e = n.da.map(function (e) {
                    return e.start.getTime();
                  }),
              ...
              var t = this.da.length - 1;
              return this.da[t].start.addDays(1);
            }),
            (this.o = function (e) {
                ...
                for (var e = 0; e < this.elements.events.length; e++) {
                  ...
                  if (
                    ...
                    t.firstChild &&
                      ...
                      "IMG" === t.firstChild.firstChild.tagName.toUpperCase())
                  ) {
            ...
            (this.ma = function (e) {
              ...
              (o.style.position = "absolute"),
                (o.style.left = e.part.left + "%"),
                (o.style.top = e.part.top + "px"),
                (o.style.width = e.part.width + "%"),
                (o.style.height = Math.max(e.part.height, 2) + "px"),
                ...
                (o.className = this.o("_event")),
                i.cssClass && DayPilot.Util.addClass(o, i.cssClass),
                (o.isFirst = e.part.start.getTime() === e.start().getTime()),
                (o.isLast = e.part.end.getTime() === e.end().getTime()),
                (o.onclick = this._),
                DayPilot.re(o, "contextmenu", this.ba),
                    ...
                    if (r && !t.resizing && !t.moving) {
                      ...
                      r.y <= a && e.client.resizeEnabled()
                        ? ((this.style.cursor = "n-resize"),
                          (this.dpBorder = "top"))
                        : this.offsetHeight - r.y <= a &&
                          e.client.resizeEnabled()
                        ? s
                  ...
                  if (
                    ...
                    if (1 === a && e.client.moveEnabled()) {
                      (t.moving = this),
                        ...
                        (t.moving.event = this.event);
                      var o = (t.moving.helper = {});
                      (o.oldColumn = n.da[this.data.part.dayIndex].id),
                        (t.originalMouse = DayPilot.mc(i)),
                        (t.originalTop = this.offsetTop);
                      var r = DayPilot.mo3(this, i);
                      r ? (t.moveOffsetY = r.y) : (t.moveOffsetY = 0),
                        (n.nav.top.style.cursor = "move");
                    }
                  } else
                    (t.resizing = this),
                      ...
                      (t.originalTop = this.offsetTop),
                      (n.nav.top.style.cursor = this.style.cursor);
                  return !1;
                });
              var r = document.createElement("div");
              if (
                (r.setAttribute("unselectable", "on"),
                (r.className = n.o("_event_inner")),
                (r.innerHTML = e.client.html()),
                "darker" === i.borderColor && i.backColor
                  ? (r.style.borderColor = DayPilot.ColorUtil.darker(
                      i.backColor,
                      2
                    ))
                ...
                var s = e.part.height - 2,
                  l = (100 * e.part.barTop) / s,
                  d = Math.ceil((100 * e.part.barHeight) / s),
                  c = document.createElement("div");
                c.setAttribute("unselectable", "on"),
                  (c.className = this.o("_event_bar")),
                  (c.style.position = "absolute"),
                  i.barBackColor && (c.style.backgroundColor = i.barBackColor);
                var u = document.createElement("div");
                u.setAttribute("unselectable", "on"),
                  (u.className = this.o("_event_bar_inner")),
                  (u.style.top = l + "%"),
                  0 < d && d <= 1
                    ? (u.style.height = "1px")
                    : (u.style.height = d + "%"),
                  i.barColor && (u.style.backgroundColor = i.barColor),
                  c.appendChild(u),
                  o.appendChild(c);
              }
              ...
              if (
                (DayPilot.Areas.attach(o, e, { areas: f }),
                a.rows[0].cells[e.part.dayIndex])
              ) {
                a.rows[0].cells[e.part.dayIndex].firstChild.appendChild(o),
                  n.na(o);
              }
                ...
                if (t.blocks)
                  for (var i = 0; i < t.blocks.length; i++)
                    for (var a = t.blocks[i], n = 0; n < a.lines.length; n++)
                      for (var o = a.lines[n], r = 0; r < o.length; r++) {
                        var s = o[r];
                        (s.part.width = 100 / a.lines.length),
                          (s.part.left = s.part.width * n);
                        var l = n === a.lines.length - 1;
                        l || (s.part.width = 1.5 * s.part.width), this.ma(s);
                      }
              }
            }),
            (this.oa = function () {
              (this.nav.top.innerHTML = ""),
                DayPilot.Util.addClass(this.nav.top, this.o("_main")),
                ...
                (this.nav.scroll.style.height = this.pa() + "px"),
              ...
              (this.nav.scrollable = t.firstChild),
                ...
                (this.nav.loading.style.backgroundColor =
                  this.loadingLabelBackColor),
                (this.nav.loading.style.fontSize = this.loadingLabelFontSize),
                (this.nav.loading.style.fontFamily =
                  this.loadingLabelFontFamily),
            ...
            (this.R = function () {
              this.fasterDispose || DayPilot.pu(this.nav.hourTable),
                ...
                (this.nav.hourTable = this.sa()),
                this.nav.scrollable.rows[0].cells[0].appendChild(
                  this.nav.hourTable
                );
            }),
            (this.ra = function () {
              ...
              return (
                ...
                i.appendChild(n),
                n.appendChild(this.ta()),
                n.appendChild(this.ua()),
                e.appendChild(t),
                (this.nav.zoom = e),
                e
              );
            ...
            (this.ua = function () {
              ...
              (e.style.top = "0px"),
                ...
                (this.nav.events = e);
              for (
                var t = this.da, i = t.length, a = e.insertRow(-1), o = 0;
                o < i;
                o++
              ) {
                ...
                (r.style.padding = "0px"),
                  ...
                  n.rtl || (r.style.textAlign = "left");
                var s = document.createElement("div");
                (s.style.marginRight = n.columnMarginRight + "px"),
            ...
            (this.sa = function () {
              ...
              for (var t = n.U(), i = 0; i < t; i++) this.va(e, i);
              return e;
            }),
            (this.va = function (e, t) {
              ...
              var s = document.createElement("div");
              (s.style.position = "relative"),
                (s.className = this.o("_rowheader")),
                (s.style.width = this.hourWidth + "px"),
                (s.style.height = i + "px"),
                (s.style.overflow = "hidden"),
                (s.unselectable = "on");
              var l = document.createElement("div");
              (l.className = this.o("_rowheader_inner")),
                (l.unselectable = "on");
              var d = document.createElement("div");
              d.unselectable = "on";
              var c = this.startDate.addHours(t).addHours(n.Y()),
                u = c.getHours(),
                h = u < 12,
                f = o.timeFormat();
              "Clock12Hours" === f && ((u %= 12), 0 === u && (u = 12)),
                (d.innerHTML = u);
              var m = document.createElement("span");
              (m.unselectable = "on"),
                (m.className = this.o("_rowheader_minutes"));
              var p;
              (p = "Clock12Hours" === f ? (h ? "AM" : "PM") : "00"),
                (m.innerHTML = p),
                d.appendChild(m),
                l.appendChild(d),
                s.appendChild(l),
            ...
            (this.qa = function () {
              ...
              if ((a.appendChild(this.nav.header), o)) {
                ...
                (r.unselectable = "on"),
                  ...
                  (r.style.width = "16px"),
                  (r.style.height = this.headerHeight + "px"),
                  (r.className = this.o("_cornerright"));
                var s = document.createElement("div");
                (s.className = this.o("_cornerright_inner")),
                  r.appendChild(s),
                  a.appendChild(r),
                  (this.nav.cornerRight = r);
              }
            ...
            (this.xa = function () {
              ...
              return (
                (t.unselectable = "on"),
                (t.className = this.o("_corner_inner")),
                e.appendChild(t),
                e
              );
            }),
            ...
            (this.Q = function () {
              var e = this.nav.main,
                ...
                a = this.X(),
                o = n.da;
              for (e && this.F(); e && e.rows && e.rows.length > 0; )
                this.fasterDispose || DayPilot.pu(e.rows[0]), e.deleteRow(0);
              this.tableCreated = !0;
              for (
                var r = o.length, s = this.nav.events;
                s && s.rows && s.rows.length > 0;

              )
                this.fasterDispose || DayPilot.pu(s.rows[0]), s.deleteRow(0);
              for (var r = o.length, l = s.insertRow(-1), d = 0; d < r; d++) {
                ...
                (c.style.padding = "0px"),
                  ...
                  n.rtl || (c.style.textAlign = "left");
                var u = document.createElement("div");
                (u.style.marginRight = n.columnMarginRight + "px"),
                  (u.style.position = "relative"),
                  (u.style.height = "1px"),
                  (u.style.marginTop = "-1px");
                var h = document.createElement("div");
              ...
              for (var f = 0; f < a; f++) {
                ...
                (l.style.MozUserSelect = "none"),
                  (l.style.KhtmlUserSelect = "none");
                for (var d = 0; d < r; d++) {
                  var m = this.da[d],
                    c = l.insertCell(-1);
                  (c.start = m.start.addTime(f * i)),
                    (c.end = c.start.addTime(i)),
                    (c.resource = m.id),
                    (c.onmousedown = this.ea),
                    ...
                    (c.style.height = n.cellHeight + "px"),
                  ...
                  (u.unselectable = "on"),
                    ...
                    (u.style.position = "relative"),
                    (u.className = this.o("_cell"));
                  this.ya(c.start, c.end) &&
                    DayPilot.Util.addClass(u, n.o("_cell_business"));
                  var p = document.createElement("div");
                  p.setAttribute("unselectable", "on"),
                    (p.className = this.o("_cell_inner")),
                    u.appendChild(p),
                    c.appendChild(u),
                    c.appendChild(u);
                }
              ...
              (e.root = this),
                (n.nav.scrollable.onmousemove = function (e) {
                  var i = n.nav.scrollable;
                  n.coords = DayPilot.mo3(i, e);
                  var a = DayPilot.mc(e);
                  if (t.resizing) {
                    t.resizingShadow ||
                      (t.resizingShadow = n.I(t.resizing, !1, n.shadow));
                    var o = n.cellHeight,
                      r = 1,
                      s = a.y - t.originalMouse.y;
                    if ("bottom" === t.resizing.dpBorder) {
                      var l =
                        Math.floor(
                          (t.originalHeight + t.originalTop + s + o / 2) / o
                        ) *
                          o -
                        t.originalTop +
                        r;
                      ...
                      t.originalTop + l > d && (l = d - t.originalTop),
                        (t.resizingShadow.style.height = l + "px");
                    } else if ("top" === t.resizing.dpBorder) {
                      var c =
                        Math.floor((t.originalTop + s - r + o / 2) / o) * o + r;
                      c < r && (c = r),
                        c > t.originalTop + t.originalHeight - o &&
                          (c = t.originalTop + t.originalHeight - o);
                      var l = t.originalHeight - (c - t.originalTop);
                      l < o ? (l = o) : (t.resizingShadow.style.top = c + "px"),
                        (t.resizingShadow.style.height = l + "px");
                    }
                  } else if (t.moving) {
                    if (
                      (t.movingShadow ||
                        ((t.movingShadow = n.I(t.moving, !n.u, n.shadow)),
                    ...
                    u || (u = o / 2);
                    var c =
                      Math.floor((n.coords.y - u - r + o / 2) / o) * o + r;
                    c < r && (c = r);
                    var h = n.nav.events,
                      d = n.nav.main.clientHeight,
                      f = parseInt(t.movingShadow.style.height);
                    c + f > d && (c = d - f),
                      DayPilot.Util.addClass(
                        t.moving,
                        n.o("_event_moving_source")
                      ),
                      (t.movingShadow.parentNode.style.display = "none"),
                      (t.movingShadow.style.top = c + "px"),
                      (t.movingShadow.parentNode.style.display = "");
                    var m = h.clientWidth / h.rows[0].cells.length,
                      p = Math.floor((n.coords.x - 45) / m);
                    p < 0 && (p = 0),
                      p < h.rows[0].cells.length &&
                        p >= 0 &&
                        t.movingShadow.column !== p &&
                        ((t.movingShadow.column = p),
                        t.moveShadow(h.rows[0].cells[p]));
                  } else if (t.selecting) {
                    var a = DayPilot.mc(e),
                      v = n.ia.getCellCoords(),
                      y = t.column,
                      g = n.nav.main.rows[v.y].cells[y];
                    a.y < t.firstMousePos.y
                      ? ((t.selectedCells = t.getCellsBelow(g)),
                        (t.topSelectedCell = t.selectedCells[0]),
                        (t.bottomSelectedCell = t.firstSelected))
                      : ((t.selectedCells = t.getCellsAbove(g)),
                        (t.topSelectedCell = t.firstSelected),
                        (t.bottomSelectedCell = t.selectedCells[0])),
                      n.fa();
                  }
            ...
            (this.za = function (e) {
              for (
                ...
                var r = i[o],
                  s = e ? t.insertCell(-1) : t.cells[o];
                (s.data = r),
                  (s.style.overflow = "hidden"),
                  (s.style.padding = "0px"),
                  (s.style.border = "0px none"),
                  (s.style.height = this.headerHeight + "px"),
                  (s.onclick = n.Aa);
                ...
                if (e) {
                  (l.unselectable = "on"),
                    ...
                    (l.className = n.o("_colheader")),
                    (l.style.height = this.headerHeight + "px"),
                    n.headerTextWrappingEnabled ||
                      (l.style.whiteSpace = "nowrap");
                  var d = document.createElement("div");
                  (d.className = n.o("_colheader_inner")),
                    (d.unselectable = "on"),
                    l.appendChild(d),
                    s.appendChild(l);
                }
                ...
                var d = l.firstChild;
                d.innerHTML = n.Ba(r.name, r.html);
              }
            }),
            (this.Aa = function (e) {
              if ("Disabled" !== n.headerClickHandling) {
                ...
                (a.header = {}),
                  (a.header.id = t.id),
                  (a.header.name = t.name),
                  (a.header.start = t.start),
                  (a.column = i),
                  (a.originalEvent = e),
                  (a.shift = e.shiftKey),
                  (a.ctrl = e.ctrlKey),
                  ...
                  ("function" == typeof n.onHeaderClick &&
                    (n.onHeaderClick(a), a.preventDefault.value)) ||
                    ("function" == typeof n.onHeaderClicked &&
                      n.onHeaderClicked(a));
              }
            }),
            (this.Ca = function (e) {
            ...
            (this.Da = function () {
              return this.width && this.width.indexOf("px") !== -1
                ? "Pixel"
                : "Percentage";
            }),
            (this.P = function () {
              ...
              for (
                i.length;
                this.headerCreated && e && e.rows && e.rows.length > 0;
            ...
            (this.commandCallBack = function (e, t) {
              var i = {};
              (i.command = e), this.B("Command", t, i);
            }),
            ...
            (this.Ea = function () {
              ...
              var t =
                "undefined" != typeof this.Ga.scrollpos
                  ? this.Ga.scrollpos
                  : this.initScrollPos;
              t &&
                ("Auto" === t &&
                  (t =
                    "BusinessHours" === this.heightSpec
                      ? 2 * this.cellHeight * this.businessBeginsHour
                      : 0),
                (e.root = this),
            ...
            (this.Ia = function () {
              t.globalHandlers ||
                ...
                DayPilot.re(window, "unload", t.gUnload));
            }),
            (this.events = {}),
            (this.events.add = function (e) {
              ...
              n.events.list || (n.events.list = []),
                n.events.list.push(t),
                n.update(),
                n.aa.notify();
            }),
            ...
            (this.events.remove = function (e) {
              ...
              n.events.list.splice(a, 1), n.update(), n.aa.notify();
            }),
                ...
                o = function (e) {
                  ...
                  if (DayPilot.isArray(i)) {
                    ...
                    if (
                      ...
                      return;
                    (n.events.list = i), n.ja && n.update();
                  }
                };
              if (
                n.eventsLoadMethod &&
                "POST" === n.eventsLoadMethod.toUpperCase()
              )
                DayPilot.Http.ajax({
                  method: "POST",
                  data: {
                ...
                var r = e,
                  s =
                    "start=" +
                    n.visibleStart().toString() +
                    "&end=" +
                    n.visibleEnd().toString();
                (r += r.indexOf("?") > -1 ? "&" + s : "?" + s),
                  DayPilot.Http.ajax({
                    method: "GET",
                    url: r,
            ...
            (this.Ja = function () {
              if (n.nav.top.className !== n.o("_main")) {
                n.nav.top.className = n.o("_main");
                var e = n.nav.corner;
                (e.className = n.o("_corner")),
                  (e.firstChild.className = n.o("_corner_inner"));
                var t = n.nav.cornerRight;
                t &&
                  ((t.className = n.o("_cornerright")),
                  (t.firstChild.className = n.o("_cornerright_inner")));
              }
            }),
            (this.update = function (e) {
              if ((n.Ka(e), this.ja)) {
                n.La(), n.E(), (n.nav.top.style.cursor = "auto");
                n.M(),
                  n.P(),
                  n.Q(),
                  n.R(),
            ...
            (this.N = function () {
              ...
              if (((n.Qa.events = []), e)) {
                if (!DayPilot.isArray(e))
                  throw new DayPilot.Exception(
                    "DayPilot.Calendar.events.list expects an array object. You supplied: " +
                      typeof e
                  );
                var t = e.length,
                  i = 864e5;
                ...
                for (var o = 0; o < t; o++) {
                  ...
                  if (!s.end)
                    throw new DayPilot.Exception(
                      "Event data item must specify 'end' property"
                    );
                  if (s instanceof DayPilot.Event)
                    throw new DayPilot.Exception(
                      "DayPilot.Calendar: DayPilot.Event object detected in events.list array. Use raw event data instead."
                    );
                  (r.start = new DayPilot.Date(r.start)),
                    (r.end = new DayPilot.Date(r.end));
                }
                if ("function" == typeof this.onBeforeEventRender)
                  for (var o = 0; o < t; o++) this.Ra(o);
                for (var o = 0; o < this.da.length; o++) {
                  var l = {};
                  (l.minEnd = 1e6),
                    (l.maxStart = -1),
                    this.scrollLabels.push(l);
                  var d = this.da[o];
                  (d.events = []), (d.lines = []), (d.blocks = []);
                  for (
                    var c = new DayPilot.Date(d.start),
                      u = c.getTime(),
                      h = c.addTime(i),
                      f = h.getTime(),
                      m = 0;
                    ...
                    if (!a[m]) {
                      ...
                      if (!(g < y)) {
                        var b = !(g <= u || y >= f);
                        if (
                          ("Resources" === n.viewType &&
                            (b = b && d.id === r.resource),
                          b)
                        ) {
                          var D = new DayPilot.Event(r, n);
                          (D.part.dayIndex = o),
                            (D.part.start = u < y ? r.start : c),
                            (D.part.end = f > g ? r.end : h);
                          var x = this.getPixels(D.part.start, d.start),
                            w = this.getPixels(D.part.end, d.start),
                            C = x.top,
                            P = w.top;
                          if (C === P && (x.cut || w.cut)) continue;
                          var _ = w.boxBottom;
                          (D.part.top =
                            Math.floor(C / this.cellHeight) * this.cellHeight +
                            1),
                            (D.part.height =
                              Math.max(
                            ...
                            (D.part.barTop = Math.max(C - D.part.top - 1, 0)),
                            (D.part.barHeight = Math.max(P - C - 2, 1));
                          var p = D.part.top,
                            v = D.part.top + D.part.height;
                          p > l.maxStart && (l.maxStart = p),
                            v < l.minEnd && (l.minEnd = v),
                            p < this.minStart && (this.minStart = p),
                            v > this.maxEnd && (this.maxEnd = v),
                            d.events.push(D),
                            "function" == typeof this.onBeforeEventRender &&
                              (D.cache = this.Qa.events[m]),
                            D.part.start.getTime() === y &&
                              D.part.end.getTime() === g &&
                              (a[m] = !0);
                        }
                      }
                    }
            ...
            (this.debug = function (e, t) {
              this.debuggingEnabled &&
                (n.debugMessages || (n.debugMessages = []),
                n.debugMessages.push(e),
            ...
            (this.getPixels = function (e, t) {
              ...
              return (
                ...
                (c.top = this.Ta(r)),
                (c.boxTop = this.Ta(l)),
                (c.boxBottom = this.Ta(d)),
                (this.cache.pixels[a + "_" + i] = c),
                c
              );
            }),
            (this.Ta = function (e) {
            ...
            (this.aa = {}),
            (this.aa.scope = null),
            (this.aa.notify = function () {
              n.aa.scope && n.aa.scope["$apply"]();
            }),
            (this.aa.apply = function (e) {
              e();
            }),
            (this.Fa = function () {
              if (n.nav.scroll) {
                var e = n.nav.scroll.scrollTop,
                  t = e / (2 * n.cellHeight);
                n.Ga.scrollHour = t;
              }
            }),
            (this.Ma = function () {
              var e = 0;
              n.Ga.scrollHour
                ? (e = 2 * n.cellHeight * n.Ga.scrollHour)
                : "Auto" === n.initScrollPos &&
                  (e =
                    "BusinessHours" === this.heightSpec
                      ? 2 * this.cellHeight * this.businessBeginsHour
                      : 0),
                (n.nav.scroll.scrollTop = e);
            }),
            (this.Ua = function () {
              return (
                !(
                  !this.backendUrl && "function" != typeof WebForm_DoCallback
                ) &&
                ("undefined" == typeof n.events.list || !n.events.list)
              );
            }),
            (this.L = function () {
            ...
            (this.Xa = function () {
              (this.Ga.themes = []),
                this.Ga.themes.push(this.theme || this.cssClassPrefix);
            }),
            (this.Ya = function () {
              for (var e = this.Ga.themes, t = 0; t < e.length; t++) {
                var i = e[t];
            ...
            (this.Za = function () {
              if (
                (this.afterRender(null, !1),
                "function" == typeof this.onAfterRender)
              ) {
                var e = {};
            ...
            (this.$a = function () {
              if ("function" == typeof this.onInit && !this._a) {
                this._a = !0;
                var e = {};
                this.onInit(e);
              }
            ...
            (this.Wa = function () {
              var e = n.ab;
              e() ||
                (n.bb = setInterval(function () {
                  e() && (n.Ea(), n.Ha(), clearInterval(n.bb));
                }, 100));
            }),
            (this.Ba = function (e, t) {
              return n.J.K()
            ...
            (this.internal = {}),
            (this.internal.loadOptions = n.Ka),
            (this.internal.xssTextHtml = n.Ba),
            (this.init = function () {
              this.Pa();
              var e = this.Ua();
              return (
        ...
        (DayPilot.CalendarColumn = function (e, t) {
          ...
          (i.id = e.id),
            (i.name = e.name),
            (i.data = e.data),
            (i.start = new DayPilot.Date(e.start)),
            (i.calendar = t),
            (i.toJSON = function () {
              var e = {};
              return (
                (e.id = this.id),
                this.start && (e.start = this.start.toString()),
                (e.name = this.name),
                e
              );
            });
        ...
        (this.onShow = null),
          ...
          (this.prepare = function () {
            if (
              ...
              (this.resetTarget = !0),
              (this.pattern = this.J.locale().datePattern),
          ...
          (this.init = function () {
            ...
            this.resetTarget && !e
              ? this.db(this.date)
              : this.resetTarget || (i.date = e);
            var t = this.eb();
            return (
              t &&
                t.addEventListener("input", function () {
                  (i.date = i.cb()),
                    i.date && i.navigator.select(i.date, { dontNotify: !0 });
                }),
          ...
          (this.setDate = function (e) {
            (this.date = new DayPilot.Date(e)), this.db(this.date);
          }),
          (this.cb = function () {
            var e = this.eb();
            ...
            if (((t = "INPUT" === e.tagName ? e.value : e.innerText), !t))
              return null;
            for (
              var a = DayPilot.Date.parse(t, i.pattern), n = 0;
              n < i.patterns.length;
              n++
            ) {
              if (a) return a;
          ...
          (this.show = function () {
            if (!this.ab) {
              var e = this.eb(),
                a = this.navigator,
                a = new DayPilot.Navigator(t);
              (a.api = 2),
                (a.cssOnly = !0),
                (a.theme = i.theme),
                (a.weekStarts = "Auto"),
                (a.locale = i.locale),
                (a.onTimeRangeSelected = function (e) {
                  i.date = e.start;
                  var t = e.start.addTime(a.fb),
                    n = t.toString(i.pattern, i.locale),
                    e = {};
                  (e.start = t),
                    (e.date = t),
              ...
              (s.style.position = "absolute"),
                "left" === r && (s.style.left = n.x + "px"),
                (s.style.top = n.y + o + "px"),
              ...
              (l.id = t),
                ...
                (this.div = s);
              var d = i.cb() || new DayPilot.Date().getDatePart();
              if (
                ((a.startDate = d),
                (a.fb = d.getTimePart()),
                (a.selectionDay = d.getDatePart()),
                a.init(),
                "right" === r)
              ) {
      ...
      (t.mouse = null),
          ...
          (this.v = "2023.2.452-lite"),
              ...
              if (
                ...
                if (
                  (i && i.isRow && i.$.row.task
                    ? ((s = new DayPilot.Task(i.$.row.task, i.calendar)),
                      (s.menuType = "resource"))
                    : (s =
                ...
                for (var u = 0; u < this.items.length; u++) {
                  ...
                  if (
                    (DayPilot.Util.addClass(f, this.hb("item")),
                    h.items &&
                      (DayPilot.Util.addClass(f, this.hb("item_haschildren")),
                      DayPilot.Util.addClass(d, this.hb("withchildren"))),
                    ...
                    if ("-" === h.text) {
                      ...
                      if (
                        ...
                        if (h.onclick) e();
                          ...
                          (p.href = h.href.replace(/\x7B0\x7D/gim, r)),
                          ...
                          var y = function (e, t) {
                            return function (i) {
                              ...
                              if (a instanceof DayPilot.Link)
                                return void o.internal.linkMenuClick(
                                  n.command,
                                  a,
                                  n.action
                                );
                              if (a instanceof DayPilot.Selection)
                                return void o.internal.timeRangeMenuClick(
                                  n.command,
                                  a,
                                  n.action
                                );
                              if (a instanceof DayPilot.Event)
                              ...
                              if (a instanceof DayPilot.Task)
                                return void ("resource" === a.menuType
                      ...
                      if (
                        ((g.className = a.hb("item_text")),
                        (g.innerHTML = DayPilot.Util.escapeTextHtml(
                          h.text,
                          h.html
                        )),
                        p.appendChild(g),
                      ...
                      var k = function (e, i) {
                        return function () {
                          ...
                          e.disabled ||
                            ((t.waitingSubmenu = {}),
                            (t.waitingSubmenu.parent = n),
                            (t.waitingSubmenu.timeout = setTimeout(function () {
                              (t.waitingSubmenu = null), a.ib(n, i);
                            }, 300)));
                        };
                      };
                ...
                if (
                  ((function () {
                    ...
                    if (e) {
                      var t = e.div,
                        i = e.e,
                        a = e.area,
                        r = a.visibility || a.v || "Visible",
                        s = e.a;
                      if (
                        ("Visible" !== r &&
                          ((s = DayPilot.Areas.createArea(t, i, a)),
                          t.appendChild(s),
                          (n = s)),
                        s)
                      ) {
                  ...
                  var N = o.parentLink,
                    ...
                    z = DayPilot.abs(o.parentLink.parentNode),
                    O = z.x + N.offsetWidth,
                    U = z.y - I;
            ...
            (this.ib = function (e, t) {
              var i = e,
                n = t.source;
              if (
                (!a.gb.submenu || a.gb.submenu.item !== e) &&
                (a.gb.submenu &&
                  a.gb.submenu.item !== e &&
                  (DayPilot.Util.removeClass(
                    a.gb.submenu.link.parentNode,
                    a.hb("item_haschildren_active")
                  ),
                  a.gb.submenu.menu.hide(),
                  (a.gb.submenu = null)),
                e.items)
              ) {
                ...
                (o.items = e.items),
                  (a.gb.submenu = {}),
                  (a.gb.submenu.menu = new DayPilot.Menu(o)),
                  (a.gb.submenu.menu.jb = a),
                  a.gb.submenu.menu.show(n, {
                    submenu: !0,
                    parentLink: t,
                    parentItem: i,
                  }),
            ...
            (this.hide = function (e) {
              ...
              if (
                (i && ((t.waitingSubmenu = null), clearTimeout(i.timeout)),
                this.removeShadow(),
                this.gb.div &&
                  this.gb.div.parentNode === document.body &&
                  document.body.removeChild(this.gb.div),
                n && (DayPilot.de(n), (n = null)),
                (a.gb.visible = !1),
                (a.gb.source = null),
                a.jb && e.hideParent && a.jb.hide(e),
                DayPilot.Menu.active === a && (DayPilot.Menu.active = null),
        ...
        (DayPilot.MenuBar = function (e, t) {
          ...
          (this.lb = function (e) {
            ...
            (this.L = function () {
              ...
              var t = this.nav.top;
              (t.className = this.lb("main")),
                DayPilot.list(i.items).forEach(function (e) {
                  var a = document.createElement("span");
                  (a.innerHTML = DayPilot.Util.escapeTextHtml(e.text, e.html)),
                    (a.className = i.lb("item")),
                    e.cssClass && a.classList.add(e.cssClass),
                    (a.data = e),
                    (a.onclick = function (t) {
                      if (i.active && i.active.item === e) i.mb();
                      else if (e.children) return void i.nb(a);
                      if ("function" == typeof e.onClick) {
                        var n = {};
                    ...
                    (a.onmouseover = function () {
                      i.active && i.active.item !== e && i.nb(a);
                    }),
                    t.appendChild(a),
                    i.elements.items.push(a);
                });
            }),
            (this.mb = function () {
              var e = i.lb("item_active");
        ...
        (DayPilot.MenuBar.deactivate = function () {
          DayPilot.MenuBar.active &&
            (DayPilot.MenuBar.active.mb(), (DayPilot.MenuBar.active = null));
        }),
  ...
  (function (DayPilot) {
    ...
    function e(t, i, a) {
      ...
      if ("__proto__" !== o && "constructor" !== o) {
        var r = i.substring(n + 1),
          s = t[o];
        ("object" == typeof s && null !== s) || ((t[o] = {}), (s = t[o])),
          e(s, r, a);
      }
    }
    function t(e, i, a) {
    ...
    if (!DayPilot.ModalStatic) {
      ...
      var i = function () {
        ...
        n = new i();
      n.add(".modal_default_main", "border: 10px solid #ccc; max-width: 90%;"),
        n.add(".modal_default_main:focus", "outline: none;"),
        n.add(".modal_default_content", "padding: 10px 0px;"),
        n.add(".modal_default_inner", "padding: 20px;"),
        n.add(".modal_default_input", "padding: 10px 0px;"),
        n.add(".modal_default_buttons", "margin-top: 10px;"),
        n.add(".modal_default_buttons", "padding: 10px 0px;"),
        n.add(
        ...
        n.add(".modal_default_form_item label", "display: block;"),
        n.add(
          ".modal_default_form_item select",
          "width: 100%; box-sizing: border-box;"
        ),
        n.add(".modal_default_form_item_label", "margin: 2px 0px;"),
        n.add(
          ".modal_default_form_item_image img",
          "max-width: 100%; height: auto;"
        ),
        n.add(".modal_default_form_item_invalid", ""),
        n.add(
        ...
        n.add(".modal_default_ok", "padding: 3px; width: 80px;"),
        n.add(".modal_default_cancel", "padding: 3px; width: 80px;"),
        n.add(".modal_default_form_item_date", "position: relative;"),
        n.add(
        ...
        n.add(".modal_default_form_item_searchable", "position: relative;"),
        n.add(".modal_default_form_item_searchable_icon", ""),
        n.add(
        ...
        n.add(".modal_default_form_item_time", "position: relative;"),
        ...
        n.add(".modal_default_form_item_datetime_parent", "display: flex;"),
        n.add(
        ...
        n.add(".modal_default_form_item_tabular_main", "margin-top: 10px;"),
        n.add(
        ...
        n.add(".modal_default_form_item_tabular_row", "display: table-row;"),
        n.add(
        ...
        n.add(".modal_min_main", "border: 1px solid #ccc; max-width: 90%;"),
        n.add(".modal_min_background", "opacity: 0.5; background-color: #000;"),
        n.add(".modal_min_ok", "padding: 3px 10px;"),
        n.add(".modal_min_cancel", "padding: 3px 10px;"),
        n.add(
        ...
        n.add(".navigator_modal_month", "font-size: 11px;"),
        n.add(".navigator_modal_day", "color: black;"),
        n.add(".navigator_modal_weekend", "background-color: #f0f0f0;"),
        n.add(".navigator_modal_dayheader", "color: black;"),
        n.add(".navigator_modal_line", "border-bottom: 1px solid #c0c0c0;"),
        n.add(".navigator_modal_dayother", "color: gray;"),
        n.add(".navigator_modal_todaybox", "border: 1px solid red;"),
        n.add(
          ".navigator_modal_title, .navigator_modal_titleleft, .navigator_modal_titleright",
          "border-top: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;color: #333;background: #f3f3f3;"
        ),
        n.add(".navigator_modal_busy", "font-weight: bold;"),
        n.add(".navigator_modal_cell", "text-align: center;"),
        n.add(
          ".navigator_modal_select .navigator_modal_cell_box",
          "background-color: #FFE794; opacity: 0.5;"
        ),
        n.add(".navigator_modal_title", "text-align: center;"),
        n.add(
          ".navigator_modal_titleleft, .navigator_modal_titleright",
          "text-align: center;"
        ),
        n.add(".navigator_modal_dayheader", "text-align: center;"),
        n.add(".navigator_modal_weeknumber", "text-align: center;"),
        n.add(".navigator_modal_cell_text", "cursor: pointer;"),
        n.commit(),
        (DayPilot.Modal = function (e) {
          ...
          (this.id = "_" + new Date().getTime() + "n" + 10 * Math.random()),
            ...
            (this.showHtml = function (e) {
              ...
              if ((this.div || this.sb(), this.tb(), this.useIframe)) {
                var t = function (e, t) {
                  return function () {
            ...
            (this.showUrl = function (e) {
              ...
              if (this.useIframe) {
                ...
                i &&
                  ...
                  this.re(this.iframe, "load", this.wb),
                  (this.iframe.src = e),
                  this.tb(),
                  this.ub(),
                  this.vb();
            ...
            (this.vb = function () {
              if ("function" == typeof t.onShow) {
                var e = {};
                (e.root = t.yb()), (e.modal = t), t.onShow(e);
              }
            }),
            (this.yb = function () {
            ...
            (this.stretch = function () {
              ...
              if (this.useIframe) {
                for (
                  var a = i() - 40, n = this.width;
                  n < a && this.Bb();
                  n += 10
                )
                  (this.div.style.width = n + "px"),
                    (this.div.style.marginLeft =
                      "-" + Math.floor(n / 2) + "px");
                for (
                ...
                this.autoStretchFirstLoadOnly &&
                  this.ue(this.iframe, "load", this.wb);
            ...
            (this.ub = function () {
              this.pb ||
                (this.re(window, "resize", this.Db),
                this.re(window, "scroll", this.Eb),
                this.dragDrop &&
                  (this.re(document, "mousemove", this.Fb),
                  this.re(document, "mouseup", this.Gb)),
                (this.pb = !0));
            }),
            (this.Hb = function () {
              this.ue(window, "resize", this.Db),
                this.ue(window, "scroll", this.Eb),
                this.dragDrop &&
                  (this.ue(document, "mousemove", this.Fb),
                  this.ue(document, "mouseup", this.Gb)),
                (this.pb = !1);
            }),
            (this.Ib = function (e) {
              e.target === t.div &&
                ...
                t.Jb(),
                (t.rb = t.mc(e || window.event)),
                (t.qb = { x: t.div.offsetLeft, y: t.div.offsetTop }));
            }),
            (this.Fb = function (e) {
              if (t.rb) {
                var e = e || window.event,
                ...
                (t.div.style.marginLeft = "0px"),
                  (t.div.style.top = t.qb.y + n + "px"),
                  (t.div.style.left = t.qb.x + a + "px");
              }
            }),
            (this.Gb = function (e) {
              t.rb && (t.Kb(), (t.div.style.cursor = null), (t.rb = null));
            }),
            (this.Jb = function () {
              if (this.useIframe) {
                var e = document.createElement("div");
            ...
            (this.Mb = {}),
            (this.Mb.container = function () {
              return t.container || document.body;
            }),
            (this.Mb.scrollY = function () {
              var e = t.Mb.container();
            ...
            (this.sb = function () {
              ...
              (o.id = this.id + "popup"),
                ...
                (o.style.width = "50px"),
                (o.style.height = "50px"),
                this.dragDrop && (o.onmousedown = this.Ib),
            ...
            (this.setInnerHTML = function (e, i) {
              ...
              n.document && (n = n.document),
                ...
                t.autoStretch &&
                  ((t.autoStretchFirstLoadOnly && t.Nb) ||
                    (t.stretch(), (t.Nb = !0)));
            }),
            ...
            (this.closeSerialized = function () {
              for (
                var e = t.yb(),
                  i = e.querySelectorAll("input, textarea, select"),
                  a = {},
                  n = 0;
                n < i.length;
                n++
      ...
      (DayPilot.Modal.form = function (t, i, a) {
        ...
        return DayPilot.getPromise(function (a, n) {
          ...
          if (
            ...
            o.div.addEventListener("keydown", function (e) {
              switch (e.keyCode) {
                case 27:
                  o.close();
                  break;
        ...
        (DayPilot.Modal.Experimental.Form = r),
      ...
      (r.prototype.create = function () {
        return this.load(), this.render(), this.Ub;
      }),
        (r.prototype.render = function () {
          var e = this;
          (this.Ub = document.createElement("div")),
            this.Qb.forEach(function (t) {
              e.createView(t);
            }),
            this.applyState();
        }),
        (r.prototype.createView = function (e) {
          ...
          if (
            ...
            e.interactive || "title" !== e.type
              ? (a.className += " " + t + "_form_item_" + e.type)
              : (a.className += " " + t + "_form_title"),
            e.data.cssClass && (a.className += " " + e.data.cssClass),
            !e.isValue)
          ) {
            var n = document.createElement("div");
            (n.className = t + "_form_item_label"),
              (n.innerText = e.text),
              a.appendChild(n);
          }
        ...
        (r.prototype.Vb = function (e, t) {
          function i() {
            e.Wb && (e.Wb.remove(), (e.Wb = null)), e.Ub.classList.add(u);
            var t = document.createElement("div");
            t.classList.add(h),
          ...
          var a = t.debounce,
            ...
            r = !0,
            s =
              "function" == typeof o.data.onValidate ? o.data.onValidate : null,
            l = "function" == typeof o.data.validate ? o.data.validate : null,
            d = s || l;
          if (d) {
            var c = {};
            (c.valid = !0),
              (c.value = e.save()[o.field]),
              (c.message = "Error"),
            ...
            if (c.valid)
              clearTimeout(this.Sb[o.field]),
                e.Wb && (e.Wb.remove(), (e.Wb = null)),
                e.Ub.classList.remove(u);
            else if (!n)
              if (a) {
                var f = 1e3;
                clearTimeout(this.Sb[o.field]),
                  (this.Sb[o.field] = setTimeout(function () {
                    i();
                  }, f));
              } else i();
            r = c.valid;
        ...
        (r.prototype.updateDependentState = function () {
          var e = this,
            t = [!0];
          (this.Rb ? this.Rb : this.Qb).forEach(function (i) {
            var a = e.updateState(i, {
              enabled: t[i.level] && !i.data.disabled,
            });
            ...
            i = {
              ...
              text: function () {
                ...
                return (
                  ...
                  (i.focus = function () {
                    i.element.focus(),
                      i.element.setSelectionRange(0, i.element.value.length);
                  }),
                  (i.save = function () {
                    var t = {};
              ...
              date: function () {
                ...
                i.apply = function (e) {
                  ...
                  o && (n.locale = o),
                    ...
                    (n.date = new DayPilot.Date(e.value));
                  var r = new DayPilot.Date(e.value).toString(
                    e.data.dateFormat || n.pattern,
                    n.locale
                  );
                  a.value = r;
                };
              ...
              select: function () {
                ...
                return (
                  ...
                  (t.save = function () {
                    ...
                    a && "undefined" != typeof a.Zb && (t = a.Zb);
                    var n = {};
              ...
              checkbox: function () {
                ...
                (n.type = "checkbox"),
                  ...
                  (n.onchange = function (e) {
                    var a = i.row;
                    t.updateState(a, { checked: this.checked }),
                      t.applyState(),
                      i.onInput({ immediate: !0 });
                  }),
                  (n.onblur = function (e) {
        ...
        (r.prototype.Xb = function (e) {
          ...
          for (
            var o = 60 / n,
              r = e.data.locale || t.locale,
              s = DayPilot.Locale.find(r) || DayPilot.Locale.US,
              c = DayPilot.Date.today(),
              u = 0;
            u < 24 * o;
            u++
          ) {
            var h = c.addMinutes(n * u),
              f = {};
          ...
          return (
            ...
            (i.save = function () {
              var t = m.selected && m.selected.id,
                i = {};
              return (i[e.field] = t), i;
            }),
            i
        ...
        (r.prototype.Yb = function (e) {
          ...
          var a = (function () {
            ...
            o = document.createElement("div");
          return (
            (o.className = t.theme + "_form_item_datetime_parent"),
            o.appendChild(a),
            o.appendChild(n),
            (i.element = o),
            (i.canFocus = function () {
            ...
            (i.save = function () {
              var t = i.searchable.selected && i.searchable.selected.id,
                a = i.picker.date ? i.picker.date.toString() : null,
                n = new DayPilot.Date(a).getDatePart(),
                o = DayPilot.Date.parse(
                  n.toString("yyyy-dd-MM ") + t,
                  "yyyy-dd-MM HH:mm"
                ),
                r = {};
        ...
        (r.prototype.findRowsByField = function (e) {
          return this.Qb.filter(function (t) {
            return t.field === e;
          });
        }),
        (r.prototype.findViewById = function (e, t) {
          return this.Tb.find(function (i) {
            return (
              i.row.field === e &&
              ("radio" !== i.row.type || i.row.resolved === t)
            );
          });
        }),
        (r.prototype.firstFocusable = function () {
          return this.Tb.find(function (e) {
            return e.canFocus && e.canFocus();
          });
        }),
        (r.prototype.updateState = function (e, t) {
          var i = this.Rb ? this.Rb : this.Qb,
            a = i.indexOf(e);
          return (
            (this.Rb = i.map(function (i) {
              if (i !== e) return i;
        ...
        (r.prototype.updateInteractive = function (e) {
          var t = this.Rb.indexOf(e);
          this.Tb[t].apply(e);
        }),
        (r.prototype.applyState = function () {
          var e = this;
          if ((this.updateDependentState(), this.Rb)) {
            this.Rb.filter(function (t, i) {
              return e.Qb[i] !== t;
            }).forEach(function (t) {
        ...
        d = function (e) {
          ...
          Object.defineProperty(this, "selected", {
            ...
            Object.defineProperty(this, "disabled", {
              ...
              set: function (e) {
                (this.$b = e),
                  this.dc && ((this.dc.disabled = e), e && this.hc());
              },
            });
      ...
      (d.prototype.select = function (e) {
        return (
          (this._b = this.data.find(function (t) {
            return t.id === e;
          })),
          this.ic(!1),
          this
        ...
        (d.prototype.create = function () {
          function e(e) {
            ...
            "includes" !== l.strategy &&
              ...
              (e = e || i || "includes"),
              (h.style.display = ""),
              (h.style.top = m.offsetHeight + "px"),
              (h.style.left = "0px"),
              (h.style.width = m.offsetWidth + "px"),
              (h.innerHTML = ""),
            ...
            l.data.forEach(function (i) {
              ...
              var r = document.createElement("div");
              (r.className = l.theme + "_list_item"),
                (r.innerText = o),
                (r.item = i),
                i === l._b && (l.bc = r),
                n || (n = r),
          ...
          function t(e) {
            ...
            document
              ...
              l.bc &&
                ((l.bc.className += " " + l.theme + "_list_item_highlight"),
                t && !i(l.bc, h) && l.bc.scrollIntoView());
          }
          function i(e, t) {
          ...
          function r() {
            (l.cc = !0), m.setAttribute("readonly", "readonly"), m.focus();
          }
          function s() {
            (l.cc = !1), m.removeAttribute("readonly"), m.select(), e("all");
          }
          var l = this,
            d = this,
            c = document.createElement("div");
          ...
          (u.className = this.theme + "_icon"),
            ...
            u.addEventListener("mousedown", function (e) {
              e.preventDefault(), l.cc ? (l.focus(), s()) : (n(), r());
            });
          var h = document.createElement("div");
          ...
          return (
            ...
            m.addEventListener("keydown", function (e) {
              ...
              if ("ArrowDown" === e.key) {
                var i = d.fc.indexOf(d.bc);
                i + 1 < d.fc.length && (d.bc = d.fc[i + 1]), t();
              } else if ("ArrowUp" === e.key) {
                var i = d.fc.indexOf(d.bc);
                i - 1 >= 0 && (d.bc = d.fc[i - 1]), t();
              } else
                "Enter" === e.key
                  ? l.bc
                    ? (e.stopPropagation(), a(l.bc))
            ...
            (this.ec = h),
            this._b ||
              ((this._b = this.data[0]), this._b && (m.value = this._b.name)),
            c.appendChild(m),
            c.appendChild(u),
            c.appendChild(f),
            c.appendChild(h),
        ...
        (d.prototype.hc = function () {
          this.jc(),
            this._b
              ? (this.dc.value = this._b.name)
              : ((this.dc.value = ""), this.ic(!0));
        }),
        (d.prototype.focus = function () {
          (this.cc = !0),
            this.dc.setAttribute("readonly", "readonly"),
            this.dc.focus(),
            this.hc();
        }),
        ...
        (d.prototype.ic = function (e) {
          if (
            ((this.gc.value = this.selected ? this.selected.id : null),
            this._b ? (this.dc.value = this._b.name) : (this.dc.value = ""),
      ...
      (c.prototype.create = function () {
          ...
          c.addEventListener("click", function (t) {
            if (!e.disabled) {
              ...
              if ("function" == typeof i) {
                var n = {};
                (n.result = e.form.serialize()),
                  (n.value = {}),
                  i(n),
                  (a = n.value);
              }
              var o = e.nc(a);
              e.Qb.push(o), e.pc(), e.qc();
            }
          }),
          (this.nav.plus = c),
          d.appendChild(c),
        ...
        (c.prototype.rc = function () {
          ...
          return !!(e && this.Qb.length >= e);
        }),
        (c.prototype.save = function () {
          var e = this,
            t = [];
          return (
            e.Qb.forEach(function (e) {
              var i = {};
        ...
        (c.prototype.uc = function (e) {
          var t = this,
            i = t.Qb.indexOf(e);
          t.Qb.splice(i, 1);
        }),
        (c.prototype.nc = function (e) {
          var t = this,
            i = {};
          return (
            (i.data = e),
        ...
        (c.prototype.oc = function (e) {
          ...
          var a = document.createElement("div");
          a.classList.add(t.theme + "_cell"),
            a.classList.add(t.theme + "_rowaction");
          var n = document.createElement("span");
          return (
            (n.className = this.theme + "_delete"),
            n.addEventListener("click", function (i) {
              t.disabled || (t.uc(e), t.pc(), t.qc());
            }),
            ...
            return (
              ...
              e.data.options.forEach(function (t) {
                ...
                (i.innerText = t.name),
                  ...
                  (i.Zb = t.id),
                  n.appendChild(i),
                  e.value === t.id && i.setAttribute("selected", !0);
              }),
              n.addEventListener("change", function (i) {
                var a = n.options[n.selectedIndex];
                a && "undefined" != typeof a.Zb && (e.value = a.Zb), t.qc();
              }),
              n
            );
          }
  ...
  (function () {
    if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
      ...
      (e.Month = function (t, i) {
        (this.v = "2023.2.452-lite"), (this.nav = {});
        var a = this;
        (this.id = t),
          (this.isMonth = !0),
          (this.api = 2),
          ...
          (this.D = function (e, t) {
            var e = JSON.parse(e);
            return e.CallBackRedirect
              ? void (document.location.href = e.CallBackRedirect)
              : "None" === e.UpdateType
              ? void a.fireAfterRenderDetached(e.CallBackData, !0)
          ...
          (this.events.update = function (e) {
            ...
            a.update(), a.aa.notify();
          }),
          (this.events.remove = function (e) {
            var t = DayPilot.indexOf(a.events.list, e.data);
            a.events.list.splice(t, 1), a.update(), a.aa.notify();
          }),
          (this.events.load = function (e, t, i) {
            var n = function (e) {
                var t = {};
          ...
          (this.N = function () {
            ...
            if (e) {
              if (!DayPilot.isArray(e))
                throw new DayPilot.Exception(
                  "DayPilot.Month.events.list expects an array object. You supplied: " +
                    typeof e
                );
              if ("function" == typeof this.onBeforeEventRender)
                for (var t = 0; t < e.length; t++) this.Ra(t);
              for (var i = 0; i < e.length; i++) {
                ...
                var n = new DayPilot.Date(a.start),
                  o = new DayPilot.Date(a.end);
                if (!(n.getTime() > o.getTime()))
                  for (var t = 0; t < this.rows.length; t++) {
                    var r = this.rows[t],
                      s = new DayPilot.Event(a, this);
                    r.belongsHere(s) &&
                      (r.events.push(s),
                      "function" == typeof this.onBeforeEventRender &&
                        (s.cache = this.Qa.events[i]));
                  }
              }
              for (var l = 0; l < this.rows.length; l++) {
                var r = this.rows[l];
                r.events.sort(this.Sa);
                for (var d = 0; d < this.rows[l].events.length; d++) {
                  var c = r.events[d],
                    u = r.getStartColumn(c),
                    h = r.getWidth(c);
          ...
          (this.drawShadow = function (t, i, a, n, o, r) {
            ...
            (this.shadow = {}),
              (this.shadow.list = []),
              (this.shadow.start = { x: t, y: i }),
              (this.shadow.width = n);
            var l = 7 * i + t - o;
            l < 0 && ((s += l), (t = 0), (i = 0));
            for (var d = o; d >= 7; ) i--, (d -= 7);
            if (d > t) {
              d > t + (7 - this.getColCount())
                ? (i--, (t = t + 7 - d))
                : ((s = s - d + t), (t = 0));
            } else t -= d;
            i < 0 && ((i = 0), (t = 0));
            ...
            for (
              e.resizingEvent
                ? (c = "w-resize")
                : e.movingEvent && (c = "move"),
                this.nav.top.style.cursor = c;
              s > 0 && i < this.rows.length;

            ) {
              var u = Math.min(this.getColCount() - t, s),
                h = this.rows[i],
                f = this.getRowTop(i),
                m = h.getHeight(),
              ...
              p.setAttribute("unselectable", "on"),
                ...
                (p.style.left = this.getCellWidth() * t + "%"),
                (p.style.width = this.getCellWidth() * u + "%"),
                (p.style.top = f + "px"),
                (p.style.height = m + "px"),
                (p.style.cursor = c);
          ...
          (this.ma = function (t) {
            var i = t.cache || t.data,
              n = t.part.row,
              o = t.part.line,
              r = t.part.colStart,
              s = t.part.colWidth,
              l = this.getCellWidth() * r,
              d = this.getCellWidth() * s,
              c = this.getEventTop(n, o),
              u = document.createElement("div");
            u.setAttribute("unselectable", "on"),
              (u.style.height = this.eventHeight + "px"),
              (u.className = this.o("_event")),
              i.cssClass && DayPilot.Util.addClass(u, i.cssClass),
              t.part.startsHere ||
                DayPilot.Util.addClass(u, this.o("_event_continueleft")),
              t.part.endsHere ||
                DayPilot.Util.addClass(u, this.o("_event_continueright")),
              (u.event = t),
              (u.style.width = d + "%"),
              (u.style.position = "absolute"),
              (u.style.left = l + "%"),
              ...
              this.showToolTip &&
                t.client.toolTip() &&
                (u.title = t.client.toolTip()),
              (u.onclick = a._),
              (u.oncontextmenu = a.Cc),
              (u.onmousedown = function (i) {
                i = i || window.event;
                ...
                if (
                  ...
                  if (
                    ...
                    (p.start = {}),
                      ...
                      (p.start.y = n),
                      (p.start.line = o),
                      (p.offset = a.eventMoveToPosition ? 0 : m),
                      (p.colWidth = s),
                      (p.event = u.event),
                      (p.coords = c),
                      (e.movingEvent = p);
              ...
              (u.onmousemove = function (i) {
                if (
                  ...
                  if (a) {
                    ...
                    var n = 6;
                    a.x <= n && t.client.resizeEnabled()
                      ? t.part.startsHere
                        ? ((u.style.cursor = "w-resize"), (u.dpBorder = "left"))
                        : (u.style.cursor = "not-allowed")
                      : u.clientWidth - a.x <= n && t.client.resizeEnabled()
                      ? t.part.endsHere
                        ? ((u.style.cursor = "e-resize"),
                          (u.dpBorder = "right"))
                        : (u.style.cursor = "not-allowed")
                      : t.client.clickEnabled()
              ...
              (u.onmouseleave = function (e) {
                u.deleteIcon && (u.deleteIcon.style.display = "none"),
                  (u.style.cursor = "");
              }),
            ...
            if (
              ...
              (h.className = this.o("_event_inner")),
              "darker" === i.borderColor && i.backColor
                ? (h.style.borderColor = DayPilot.ColorUtil.darker(
                    i.backColor,
                    2
                  ))
                : (h.style.borderColor = i.borderColor),
              i.backColor &&
                ((h.style.background = i.backColor),
                (DayPilot.browser.ie9 || DayPilot.browser.ielt9) &&
                  (h.style.filter = "")),
              i.fontColor && (h.style.color = i.fontColor),
              (h.innerHTML = t.client.html()),
              u.appendChild(h),
              t.client.barVisible())
            ) {
              var f = document.createElement("div");
              f.setAttribute("unselectable", "on"),
                (f.className = this.o("_event_bar")),
                (f.style.position = "absolute");
              var m = document.createElement("div");
              m.setAttribute("unselectable", "on"),
                (m.className = this.o("_event_bar_inner")),
                (m.style.top = "0%"),
                (m.style.height = "100%"),
                i.barColor && (m.style.backgroundColor = i.barColor),
                f.appendChild(m),
                u.appendChild(f);
            }
            if (t.client.deleteEnabled()) {
              var p = Math.floor(a.eventHeight / 2 - 9),
            ...
            DayPilot.Areas.attach(u, t, { areas: y }),
              this.elements.events.push(u),
              this.nav.events.appendChild(u);
          }),
          ...
          (this.yc = function () {
            ...
            var e,
              t = (this.startDate, this.lastVisibleDayOfMonth()),
              i = DayPilot.DateUtil.daysDiff(this.firstDate, t) + 1;
            (e = Math.ceil(i / 7)), (this.days = 7 * e), (this.rows = []);
            for (var n = 0; n < e; n++) {
              var o = {};
              (o.start = this.firstDate.addDays(7 * n)),
                (o.end = o.start.addDays(this.getColCount())),
                (o.events = []),
                (o.lines = []),
                (o.index = n),
                (o.minHeight = this.cellHeight),
                (o.calendar = this),
                (o.belongsHere = function (e) {
                  return (
                    (e.end().getTime() === e.start().getTime() &&
                      e.start().getTime() === this.start.getTime()) ||
                    !(
                      e.end().getTime() <= this.start.getTime() ||
                      e.start().getTime() >= this.end.getTime()
                    )
                  );
                }),
                  ...
                  return (
                    (r.isFree = function (e, t) {
                      for (var i = !0, a = 0; a < this.length; a++)
                        e + t - 1 < this[a].part.colStart ||
                          e >
                            this[a].part.colStart + this[a].part.colWidth - 1 ||
                          (i = !1);
                      return i;
                    }),
                    (r.addEvent = function (e, t, i, a, o) {
                      (e.part.colStart = t),
                        ...
                        (e.part.line = o),
                        (e.part.startsHere =
                          n.start.getTime() <= e.start().getTime()),
                        (e.part.endsHere =
                          n.end.getTime() >= e.end().getTime()),
                        this.push(e);
                    }),
                    r.addEvent(e, t, i, a, this.lines.length),
                    this.lines.push(r),
                    this.lines.length - 1
                  );
                }),
                ...
                (o.getHeight = function () {
                  return Math.max(
                    this.lines.length * a.lineHeight() + a.cellHeaderHeight,
          ...
          (this.oa = function () {
            ...
            t.setAttribute("unselectable", "on"),
              ...
              this.width && (t.style.width = this.width),
              (t.style.height = this.getHeight() + "px"),
              (t.onselectstart = function (e) {
                return !1;
              }),
              this.hideUntilInit && (t.style.visibility = "hidden"),
              this.visible || (t.style.display = "none"),
              (t.className = this.o("_main"));
              ...
              (t.onmousemove = function (t) {
                if (e.resizingEvent) {
                  ...
                  if ("w-resize" === s.direction) {
                    ...
                    (r = a.getCellFromDate(s.event.start())),
                      (o = a.getWidth(r, n));
                  ...
                  if (!i) return;
                  if (
                    i.x === e.movingEvent.coords.x &&
                    i.y === e.movingEvent.coords.y
                  )
                    return;
                  var n = a.getCellBelowPoint(i.x, i.y);
                  a.clearShadow();
                  var c = e.movingEvent.event,
                    u = e.movingEvent.offset,
                    o = a.cellMode
                      ? 1
                      : DayPilot.DateUtil.daysSpan(c.start(), c.end()) + 1;
                  ...
                  o < 1 && (o = 1);
                  var m = h < f ? r : n;
                  (e.timeRangeSelecting.from = { x: m.x, y: m.y }),
                    (e.timeRangeSelecting.width = o),
                    (e.timeRangeSelecting.moved = !0),
                    a.drawShadow(m.x, m.y, 0, o, 0, null);
                }
              });
          }),
          (this.S = function () {
            ...
            for (var e = 0; e < this.cells.length; e++)
              for (var t = 0; t < this.cells[e].length; t++)
                (this.cells[e][t].style.top = this.getRowTop(t) + "px"),
                  (this.cells[e][t].style.height =
                    this.rows[t].getHeight() + "px");
          }),
          (this.getCellBelowPoint = function (e, t) {
            for (
              var i = Math.floor(this.nav.top.clientWidth / this.getColCount()),
                a = Math.min(Math.floor(e / i), this.getColCount() - 1),
                n = null,
                o = this.headerHeight,
                r = 0,
                s = 0;
          ...
          (this.Ac = function () {
            ...
            for (var t = 0; t < this.getColCount(); t++) {
              ...
              o.setAttribute("unselectable", "on"),
                ...
                (o.style.left = "0px"),
                (o.style.right = "0px"),
                (o.className = this.o("_header_inner")),
                (o.innerHTML = n.locale().dayNames[a]),
                e.appendChild(i);
              for (var r = 0; r < this.rows.length; r++) this.Dc(t, r, e);
            }
          }),
          (this.zc = function () {
            for (var e = 0; e < this.cells.length; e++)
          ...
          (this.Dc = function (t, i, o) {
            var r = this.rows[i],
              s = this.firstDate.addDays(7 * i + t),
              l = document.createElement("div");
            if (
              (l.setAttribute("unselectable", "on"),
              (l.style.position = "absolute"),
              (l.style.cursor = "default"),
              (l.style.left = this.getCellWidth() * t + "%"),
              (l.style.width = this.getCellWidth() + "%"),
              (l.style.top = this.getRowTop(i) + "px"),
              (l.style.height = r.getHeight() + "px"),
              (l.className = this.o("_cell")),
              !this.isWeekend(s))
            ) {
              var d = this.o("_cell_business");
              DayPilot.Util.addClass(l, d);
            }
            var c =
              (this.startDate.addMonths(-1).getMonth(),
              this.startDate.addMonths(1).getMonth(),
            ...
            var u = document.createElement("div");
            u.setAttribute("unselectable", "on"),
              (u.style.height = this.cellHeaderHeight + "px"),
              (u.className = this.o("_cell_header")),
            ...
            var h = s.getDay();
            1 === h
              ? (u.innerHTML = n.locale().monthNames[s.getMonth()] + " " + h)
              : (u.innerHTML = h),
              c.appendChild(u),
              (this.cells[t][i] = l),
              o.appendChild(l);
          ...
          (this.B = function (e, t, i) {
            ...
            this.backendUrl &&
              DayPilot.request(this.backendUrl, this.C, n, this.ajaxError);
          }),
          (this.C = function (e) {
            a.D(e.responseText);
          }),
          ...
          (this.eventMoveCallBack = function (e, t, i, a, n) {
            ...
            (o.e = e),
              ...
              (o.newEnd = i),
              (o.position = n),
              this.B("EventMove", a, o);
          }),
          (this.p = function (e, t, i, n, o, r) {
            var s = e.start().getTimePart(),
              l = e.end().getDatePart();
            l !== e.end() && (l = l.addDays(1));
            var d = DayPilot.DateUtil.diff(e.end(), l),
              c = this.getDateFromCell(t, i);
            c = c.addDays(-n);
            var u = DayPilot.DateUtil.daysSpan(e.start(), e.end()) + 1,
              h = c.addDays(u),
              f = c.addTime(s),
              m = h.addTime(d);
            if (a.Z()) {
          ...
          (this.n = function (e, t, i) {
            ...
            var r = DayPilot.DateUtil.diff(e.end(), o),
              s = this.getDateFromCell(t.x, t.y),
              l = s.addDays(i),
              d = s.addTime(n),
              c = l.addTime(r);
            if (a.Z()) {
          ...
          (this.timeRangeSelectedCallBack = function (e, t, i) {
            var a = {};
            (a.start = e), (a.end = t), this.B("TimeRangeSelected", i, a);
          }),
          (this.q = function (e, t) {
            if (this.Z()) {
              var i = {};
        ...
        (this.debug = function (e, t) {
          this.debuggingEnabled &&
            (a.debugMessages || (a.debugMessages = []),
            a.debugMessages.push(e),
            "undefined" != typeof console && console.log(e));
        }),
          (this.dispose = function () {
            var e = a;
          ...
          (this.Ia = function () {
            e.globalHandlers ||
              ((e.globalHandlers = !0),
              DayPilot.re(document, "mouseup", e.gMouseUp));
          }),
          (this.loadFromServer = function () {
            return (
              !(!this.backendUrl && "function" != typeof WebForm_DoCallback) &&
              ("undefined" == typeof a.events.list || !a.events.list)
            );
          }),
          (this.L = function () {
            "hidden" === this.nav.top.style.visibility &&
          ...
          (this.Va = function () {
            this.yc(), this.oa(), this.Ac(), this.Ia(), this.B("Init");
          }),
          (this.Ba = function (e, t) {
            return a.J.K()
              ? DayPilot.Util.escapeTextHtml(e, t)
          ...
          (this.internal = {}),
          (this.internal.loadOptions = this.Ka),
          (this.internal.xssTextHtml = a.Ba),
          (this.init = function () {
            return (
              this.Pa(),
              this.loadFromServer()
                ...
                : (this.yc(),
                  ...
                  this.T(),
                  this.Ia(),
                  this.fireAfterRenderDetached(null, !1),
                  (this.ja = !0),
                  this)
            );
          }),
        ...
        (e.gMouseUp = function (t) {
          if (e.movingEvent) {
            ...
            var a = e.movingEvent.event.calendar,
              n = e.movingEvent.event,
              o = a.shadow.start,
              r = a.shadow.position,
              s = e.movingEvent.offset;
          ...
          if (e.resizingEvent) {
            ...
            if (!i.event.calendar.shadow) return;
            if (!i.event.calendar.shadow.start) return;
            var a = e.resizingEvent.event.calendar,
              n = e.resizingEvent.event,
              o = a.shadow.start,
              l = a.shadow.width;
            return (
              a.clearShadow(),
              (e.resizingEvent = null),
              a.n(n, o, l),
              (t.cancelBubble = !0),
              (e.resizingEvent = null),
              !1
          ...
          if (e.timeRangeSelecting) {
            if (e.timeRangeSelecting.moved) {
              var d = e.timeRangeSelecting,
                a = d.root,
                o = new DayPilot.Date(a.getDateFromCell(d.from.x, d.from.y)),
                c = o.addDays(d.width);
              a.q(o, c), a.clearShadow();
            }
            e.timeRangeSelecting = null;
          }
        }),
        (DayPilot.Month = e.Month),
        "undefined" != typeof jQuery &&
          !(function (e) {
    ...
    if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
      (DayPilot.Navigator = function (e, t) {
        ...
        (this.id = e),
          ...
          (this.Ec = function () {
            (this.root.dp = this),
              (this.root.className = this.o("_main")),
              "Horizontal" === this.orientation
                ? ((this.root.style.width =
                    this.showMonths * (7 * o.cellWidth() + this.Fc()) + "px"),
          ...
          (this.Ac = function (e, t) {
            ...
            var g = this.titleHeight + this.dayHeaderHeight,
            ...
            var D = document.createElement("div");
            (D.style.position = "absolute"),
              (D.style.left = o.cellWidth() + "px"),
              (D.style.top = "0px"),
              (D.style.width = 5 * o.cellWidth() + this.Fc() + "px"),
              (D.style.height = this.titleHeight + "px"),
              (D.style.lineHeight = this.titleHeight + "px"),
              D.setAttribute("unselectable", "on"),
              (D.className = this.o("_title")),
              (D.innerHTML =
                o.locale().monthNames[n.getMonth()] + " " + n.getYear()),
              v.appendChild(D),
              (this.ti = D);
            var x = document.createElement("div");
            (x.style.position = "absolute"),
              (x.style.left = 6 * o.cellWidth() + this.Fc() + "px"),
              (x.style.right = 6 * o.cellWidth() + this.Fc() + "px"),
              (x.style.top = "0px"),
              (x.style.width = o.cellWidth() + "px"),
              (x.style.height = this.titleHeight + "px"),
              (x.style.lineHeight = this.titleHeight + "px"),
              x.setAttribute("unselectable", "on"),
              (x.className = this.o("_titleright")),
              t.right &&
            ...
            if (this.showWeekNumbers)
              for (var C = 0; C < h; C++) {
                ...
                switch (this.weekNumberAlgorithm) {
                  case "Auto":
                    _ =
                      1 === o.weekStarts() ? P.weekNumberISO() : P.weekNumber();
                    break;
                  case "US":
                    _ = P.weekNumber();
                    break;
                ...
                (k.style.position = "absolute"),
                  (k.style.left = "0px"),
                  (k.style.right = "0px"),
                  (k.style.top = C * this.cellHeight + g + "px"),
                  (k.style.width = o.cellWidth() + "px"),
                  (k.style.height = this.cellHeight + "px"),
                  (k.style.lineHeight = this.cellHeight + "px"),
                  k.setAttribute("unselectable", "on"),
                  (k.className = this.o("_weeknumber")),
                  (k.innerHTML = "<span>" + _ + "</span>"),
                  v.appendChild(k),
                  a.weeks.push(k);
              }
            for (var S = 0; S < 7; S++) {
              ...
              var k = document.createElement("div");
              (k.style.position = "absolute"),
                (k.style.left = S * o.cellWidth() + w + "px"),
                (k.style.right = S * o.cellWidth() + w + "px"),
                (k.style.top = this.titleHeight + "px"),
                (k.style.width = o.cellWidth() + "px"),
                (k.style.height = this.dayHeaderHeight + "px"),
                (k.style.lineHeight = this.dayHeaderHeight + "px"),
                k.setAttribute("unselectable", "on"),
                (k.className = this.o("_dayheader")),
                (k.innerHTML = "<span>" + this.Kc(S) + "</span>"),
                v.appendChild(k),
                a.days.push(k);
              for (var C = 0; C < h; C++) {
                var P = d.addDays(7 * C + S),
                  M = this.Lc(P) && "none" !== this.Mc(),
                  T = P.firstDayOfMonth() === n,
                  A = P < n,
                  H = P >= n.addMonths(1);
                if ("month" === this.Mc()) M = M && T;
                else if ("day" === this.Mc())
                  M = M && (T || (r && A) || (s && H));
                else if ("week" === this.Mc()) {
                ...
                (N.day = P),
                  ...
                  (N.showBefore = r),
                  (N.showAfter = s),
                  (N.className = this.o(T ? "_day" : "_dayother")),
                  i.Gc(N, "cell"),
                  P.getTime() === f.getTime() && T && this.Gc(N, "today"),
                  (0 !== P.dayOfWeek() && 6 !== P.dayOfWeek()) ||
                    this.Gc(N, "weekend"),
                  (N.style.position = "absolute"),
                  (N.style.left = z + "px"),
                  (N.style.right = z + "px"),
                  (N.style.top = O + "px"),
                  (N.style.width = o.cellWidth() + "px"),
                  (N.style.height = this.cellHeight + "px"),
                  (N.style.lineHeight = this.cellHeight + "px");
                var U = document.createElement("div");
                (U.style.position = "absolute"),
                  (U.className =
                    P.getTime() === f.getTime() && T
                      ? this.o("_todaybox")
                      : this.o("_daybox")),
                  i.Gc(U, "cell_box"),
                  (U.style.left = "0px"),
                ...
                if (
                  ...
                  (L.cell = R || {}),
                    (L.cell.day = P),
                    (L.cell.isCurrentMonth = T),
                    (L.cell.isToday = P.getTime() === f.getTime() && T),
                    (L.cell.isWeekend =
                      0 === P.dayOfWeek() || 6 === P.dayOfWeek()),
                    R
                      ? ((L.cell.html = R.html || P.getDay()),
                        (L.cell.cssClass = R.css))
                      : ((L.cell.html = P.getDay()), (L.cell.cssClass = null)),
                    i.onBeforeCellRender(L),
                    (R = L.cell);
                }
                if (
                  (R && DayPilot.Util.addClass(N, R.cssClass || R.css),
                  T || (r && A) || (s && H))
                ) {
                  var B = document.createElement("div");
                  (B.innerHTML = P.getDay()),
                    (B.style.position = "absolute"),
                    (B.style.left = "0px"),
                    (B.style.top = "0px"),
                    (B.style.right = "0px"),
                    ...
                    i.Gc(B, "cell_text"),
                    (N.isClickable = !0),
                    R && R.html && (B.innerHTML = R.html),
                    N.appendChild(B);
                }
                N.setAttribute("unselectable", "on"),
                  (N.onclick = this.Oc),
                  v.appendChild(N),
                  M && (i.Pc(v, S, C), this.selected.push(N));
              }
            }
            ...
            (j.style.position = "absolute"),
              (j.style.left = "0px"),
              (j.style.top = g - 2 + "px"),
              (j.style.width = 7 * o.cellWidth() + this.Fc() + "px"),
              (j.style.height = "1px"),
              (j.style.fontSize = "1px"),
              (j.style.lineHeight = "1px"),
              (j.className = this.o("_line")),
              v.appendChild(j),
              this.months.push(a);
          }),
          ...
          (this.Pc = function (e, t, a) {
            var n = e.month.cells[t][a];
            i.Gc(n, "select");
          }),
          (this.Qc = function (e, t, a) {
            var n = e.month.cells[t][a];
            i.Hc(n, "select");
          }),
          (this.Fc = function () {
              ...
              for (var e = 0; e < this.showMonths; e++)
                for (var t = 0; t < 7; t++)
                  for (var i = 0; i < 6; i++) {
                    ...
                    a &&
                      (1 === this.items[a.day.toStringSortable()]
                        ? (this.Gc(a, "busy"), this.Hc(a, "free"))
                        : (this.Hc(a, "busy"), this.Gc(a, "free")));
                  }
          }),
          (this.Sc = function () {
            var e = {};
          ...
          (this.Uc = null),
          (this.select = function (e, t, a) {
            var n = t && (t instanceof DayPilot.Date || "string" == typeof t),
              o = (t && "object" == typeof t) || "boolean" == typeof t,
              r = e,
              s = n ? t : null,
              l = o ? t : a;
            if (!this.ja)
              return void (this.Uc = { date1: r, date2: s, options: l });
            var d = !0,
              c = !0;
            l && "object" == typeof l
            ...
            if (d) {
              ...
              (this.selectionStart < this.Vc() ||
                this.selectionStart >= this.Wc()) &&
                (m = this.selectionStart.firstDayOfMonth()),
                m.toStringSortable() !== this.startDate.toStringSortable() &&
                  (f = !0),
                (this.startDate = m);
            }
            s && i.freeHandSelectionEnabled
              ? (i.selectionEnd = new DayPilot.Date(s))
              : this.Tc(),
              this.zc(),
              this.Ec(),
              this.Xc(),
          ...
          (this.update = function (e) {
            if ((i.Ka(e), this.ja)) {
              ...
              i.tb(),
                (t.start === i.selectionStart &&
                  t.end == i.selectionEnd &&
                  t.day === i.selectionDay) ||
                  i.q();
            }
          }),
          (this.tb = function () {
          ...
          (this.B = function (e, t, i) {
            ...
            this.backendUrl
              ? DayPilot.request(this.backendUrl, this.C, n, this._c)
              : WebForm_DoCallback(
                  this.uniqueID,
                  n,
                  this.D,
          ...
          (this.cd = function (e) {
            ...
            if (n.top <= t.y && t.y < n.top + o)
              return { month: a, x: 0, y: 0, coords: t, header: !0 };
          ...
          (this.ed = function (e) {
            if (a.start) {
              ...
              if (a.end) a.end = t;
                ...
                var n = 3,
                  o = DayPilot.distance(a.start.coords, t.coords);
                o > n && (a.end = t);
              }
        ...
        (a.start = null),
          (a.drawCell = function (e) {
            ...
            (s.style.position = "absolute"),
              (s.style.left = r + "px"),
              (s.style.top = o + "px"),
              (s.style.height = i.cellHeight + "px"),
              (s.style.width = i.cellWidth + "px"),
              (s.style.backgroundColor = "#ccc"),
              (s.style.opacity = 0.5),
              (s.style.cursor = "default"),
              i.nav.preselection.appendChild(s),
              a.cells.push(s);
          }),
          (a.clear = function () {
            if (a.cells) {
        ...
        (this.Oc = function (e) {
            ...
            switch (i.Mc()) {
              ...
              case "day":
                if (i.autoFocusOnClick) {
                  var s = r;
                  if (r < i.Vc() || r >= i.Wc()) return void i.select(r);
                }
                var l = a.cells[n][o];
                i.Pc(t, n, o),
                  i.selected.push(l),
                  (i.selectionStart = l.day),
                  (i.selectionEnd = l.day);
                break;
              case "week":
                if (i.autoFocusOnClick) {
                  var s = a.cells[0][o].day,
                    d = a.cells[6][o].day;
                  if (
                ...
                for (var c = 0; c < 7; c++)
                  i.Pc(t, c, o), i.selected.push(a.cells[c][o]);
                (i.selectionStart = a.cells[0][o].day),
                  (i.selectionEnd = a.cells[6][o].day);
                break;
              case "month":
                if (i.autoFocusOnClick) {
                  var s = r;
                ...
                for (var s = null, d = null, o = 0; o < 6; o++)
                  for (var n = 0; n < 7; n++) {
                    var l = a.cells[n][o];
                    l &&
                      l.day.getYear() === r.getYear() &&
                      l.day.getMonth() === r.getMonth() &&
                      (i.Pc(t, n, o),
                      i.selected.push(l),
                      null === s && (s = l.day),
                      (d = l.day));
          ...
          (this.q = function (e) {
            var t = i.selectionStart,
              a = i.selectionEnd.addDays(1),
              n = DayPilot.DateUtil.daysDiff(t, a),
              o = i.selectionDay;
            if (((e = e || {}), i.Z())) {
              var r = {};
              if (
                ...
                case "Bind":
                  if ("object" == typeof bound) {
                    ...
                    (s.start = t),
                      ...
                      (s.days = n),
                      (s.day = o),
                      bound.commandCallBack(i.command, s);
                  }
                  break;
                case "None":
                  break;
            ...
            if (i.Z()) {
              ...
              if (
                ...
                "function" == typeof i.onVisibleRangeChange &&
                  (i.onVisibleRangeChange(a), a.preventDefault.value))
              )
                return;
          ...
          (this.Xc = function () {
            ...
            (this.root.style.height = this.jd() + "px"),
          ...
          (this.aa.scope = null),
          (this.aa.notify = function () {
            i.aa.scope && i.aa.scope["$apply"]();
          }),
          (this.internal = {}),
          (this.internal.loadOptions = i.Ka),
        ...
        (o.locale = function () {
          ...
          (o.cellWidth = function () {
            if (i.Qa.cellWidth) return i.Qa.cellWidth;
            var e = i.kd("_cell_dimensions").width;
            return e || (e = i.cellWidth), (i.Qa.cellWidth = e), e;
          }),
          (this.clearSelection = function () {
            for (var e = 0; e < this.selected.length; e++) {
              var t = this.selected[e];
              i.Qc(t.parentNode, t.x, t.y);
            }
            this.selected = [];
          }),
          (this.ld = function () {
          ...
          (this.init = function () {
            if ((this.Pa(), !this.root.dp)) {
              this.Tc(),
                ...
                this.Ia();
              if (
                (this.ld() && this.Yc(), (this.ja = !0), this.Oa(), this.Uc)
              ) {
                var e = this.Uc;
                this.select(e.date1, e.date2, e.options), (this.Uc = null);
              }
              return this;
            }
          }),
          (this.nd = function () {
            (i.nav.top.onmousedown = this.dd),
              (i.nav.top.onmousemove = this.ed);
          }),
          (this.Ia = function () {
            DayPilot.re(document, "mouseup", i.od);
          }),
          (this.od = function (e) {
            if (a.start && a.end) {
              var t = DayPilot.mo3(i.nav.top, e);
              ...
              a.clear();
              var o = a.ordered();
              (o.start = new n(o.start).nextVisible()),
                (o.end = new n(o.end).previousVisible()),
                (i.selectionDay = new n(o.start).date()),
                (i.selectionStart = i.selectionDay),
                (i.selectionEnd = new n(o.end).date()),
                (a.start = null),
                (a.end = null),
                i.zc(),
                i.Ec(),
