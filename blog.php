      ...
      <div class="doctors-plans-heading">
        ...
        <div class="heading-wrapper">
          <h1 class="display-title bold">
            Navigating Ophthalmic Challenges with Dr. Aakash Deep
          </h1>
        </div>
      </div>
      <div class="doctors-blocks-wrapper">
        ...
        while ($row = mysqli_fetch_assoc($res)) {
          ...
          <div class="doctor-block">
            <img src="<?php echo 'backend/admin/' . $arc_images; ?>" loading="lazy"
              sizes="(max-width: 479px) 92vw, (max-width: 767px) 94vw, (max-width: 991px) 39vw, 350px" srcset="<?php echo 'backend/admin/' . $arc_images; ?> 500w,
                <?php echo 'backend/admin/' . $arc_images; ?> 704w" alt="doctor&#x27;s image" class="doctor-image" />
            <div class="doctor-block-text">
              ...
              <div class="appointment-cta">
                <a href="blog-details?id=<?php echo $id; ?>&title=<?php echo $title; ?>" class="primary-btn _15px w-button">Learn More</a>
              </div>
            </div>
          </div>
        <?php } ?>
